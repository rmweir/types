...
import (
	...
	v1a "github.com/rancher/types/apis/networking.k8s.io/v1"
...
// Ensure, that NetworkPolicyListerMock does implement NetworkPolicyLister.
// If this is not the case, regenerate this file with moq.
var _ v1a.NetworkPolicyLister = &NetworkPolicyListerMock{}
...
// If this is not the case, regenerate this file with moq.
var _ v1a.NetworkPolicyController = &NetworkPolicyControllerMock{}
...
//             AddClusterScopedFeatureHandlerFunc: func(enabled func() bool, ctx context.Context, name string, clusterName string, handler v1a.NetworkPolicyHandlerFunc)  {
...
//             },
//             AddFeatureHandlerFunc: func(enabled func() bool, ctx context.Context, name string, sync v1a.NetworkPolicyHandlerFunc)  {
...
func (mock *NetworkPolicyControllerMock) AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name string, clusterName string, handler v1a.NetworkPolicyHandlerFunc) {
...
func (mock *NetworkPolicyControllerMock) AddFeatureHandler(enabled func() bool, ctx context.Context, name string, sync v1a.NetworkPolicyHandlerFunc) {
...
func (mock *NetworkPolicyControllerMock) Lister() v1a.NetworkPolicyLister {
...
// Ensure, that NetworkPolicyInterfaceMock does implement NetworkPolicyInterface.
// If this is not the case, regenerate this file with moq.
var _ v1a.NetworkPolicyInterface = &NetworkPolicyInterfaceMock{}
...
//             AddClusterScopedFeatureHandlerFunc: func(enabled func() bool, ctx context.Context, name string, clusterName string, sync v1a.NetworkPolicyHandlerFunc)  {
// 	               panic("mock out the AddClusterScopedFeatureHandler method")
//             },
//             AddClusterScopedFeatureLifecycleFunc: func(enabled func() bool, ctx context.Context, name string, clusterName string, lifecycle v1a.NetworkPolicyLifecycle)  {
...
// 	               panic("mock out the AddFeatureHandler method")
//             },
//             AddFeatureLifecycleFunc: func(enabled func() bool, ctx context.Context, name string, lifecycle v1a.NetworkPolicyLifecycle)  {
...
// AddClusterScopedFeatureHandler calls AddClusterScopedFeatureHandlerFunc.
func (mock *NetworkPolicyInterfaceMock) AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name string, clusterName string, sync v1a.NetworkPolicyHandlerFunc) {
	if mock.AddClusterScopedFeatureHandlerFunc == nil {
...
func (mock *NetworkPolicyInterfaceMock) AddClusterScopedFeatureLifecycle(enabled func() bool, ctx context.Context, name string, clusterName string, lifecycle v1a.NetworkPolicyLifecycle) {
...
// AddFeatureHandler calls AddFeatureHandlerFunc.
func (mock *NetworkPolicyInterfaceMock) AddFeatureHandler(enabled func() bool, ctx context.Context, name string, sync v1a.NetworkPolicyHandlerFunc) {
	if mock.AddFeatureHandlerFunc == nil {
...
func (mock *NetworkPolicyInterfaceMock) AddFeatureLifecycle(enabled func() bool, ctx context.Context, name string, lifecycle v1a.NetworkPolicyLifecycle) {
...
// AddHandler calls AddHandlerFunc.
func (mock *NetworkPolicyInterfaceMock) AddHandler(ctx context.Context, name string, sync v1a.NetworkPolicyHandlerFunc) {
	if mock.AddHandlerFunc == nil {
...
func (mock *NetworkPolicyInterfaceMock) Controller() v1a.NetworkPolicyController {
...
// Get calls GetFunc.
func (mock *NetworkPolicyInterfaceMock) Get(name string, opts v1b.GetOptions) (*v1.NetworkPolicy, error) {
	if mock.GetFunc == nil {
...
func (mock *NetworkPolicyInterfaceMock) Watch(opts v1b.ListOptions) (watch.Interface, error) {
...
// Ensure, that NetworkPoliciesGetterMock does implement NetworkPoliciesGetter.
// If this is not the case, regenerate this file with moq.
var _ v1a.NetworkPoliciesGetter = &NetworkPoliciesGetterMock{}
