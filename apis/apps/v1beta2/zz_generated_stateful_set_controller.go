...
type StatefulSetController interface {
	...
	AddFeatureHandler(enabled func() bool, ctx context.Context, name string, sync StatefulSetHandlerFunc)
	AddClusterScopedHandler(ctx context.Context, name, clusterName string, handler StatefulSetHandlerFunc)
	AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name, clusterName string, handler StatefulSetHandlerFunc)
...
type StatefulSetInterface interface {
	...
	AddFeatureLifecycle(enabled func() bool, ctx context.Context, name string, lifecycle StatefulSetLifecycle)
	AddClusterScopedHandler(ctx context.Context, name, clusterName string, sync StatefulSetHandlerFunc)
	AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name, clusterName string, sync StatefulSetHandlerFunc)
	AddClusterScopedLifecycle(ctx context.Context, name, clusterName string, lifecycle StatefulSetLifecycle)
	AddClusterScopedFeatureLifecycle(enabled func() bool, ctx context.Context, name, clusterName string, lifecycle StatefulSetLifecycle)
}
...
func (c *statefulSetController) AddFeatureHandler(enabled func() bool, ctx context.Context, name string, handler StatefulSetHandlerFunc) {
	c.GenericController.AddHandler(ctx, name, func(key string, obj interface{}) (interface{}, error) {
		if !enabled() {
			return nil, nil
		} else if obj == nil {
...
func (c *statefulSetController) AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name, cluster string, handler StatefulSetHandlerFunc) {
	resource.PutClusterScoped(StatefulSetGroupVersionResource)
	c.GenericController.AddHandler(ctx, name, func(key string, obj interface{}) (interface{}, error) {
		if !enabled() {
			return nil, nil
...
func (s *statefulSetClient) AddFeatureHandler(enabled func() bool, ctx context.Context, name string, sync StatefulSetHandlerFunc) {
...
func (s *statefulSetClient) AddFeatureLifecycle(enabled func() bool, ctx context.Context, name string, lifecycle StatefulSetLifecycle) {
	sync := NewStatefulSetLifecycleAdapter(name, false, s, lifecycle)
	s.Controller().AddFeatureHandler(enabled, ctx, name, sync)
}
...
func (s *statefulSetClient) AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name, clusterName string, sync StatefulSetHandlerFunc) {
...
func (s *statefulSetClient) AddClusterScopedFeatureLifecycle(enabled func() bool, ctx context.Context, name, clusterName string, lifecycle StatefulSetLifecycle) {
	sync := NewStatefulSetLifecycleAdapter(name+"_"+clusterName, true, s, lifecycle)
	s.Controller().AddClusterScopedFeatureHandler(enabled, ctx, name, clusterName, sync)
}
