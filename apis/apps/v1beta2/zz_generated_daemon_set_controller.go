...
type DaemonSetController interface {
	...
	AddFeatureHandler(enabled func() bool, ctx context.Context, name string, sync DaemonSetHandlerFunc)
	AddClusterScopedHandler(ctx context.Context, name, clusterName string, handler DaemonSetHandlerFunc)
	AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name, clusterName string, handler DaemonSetHandlerFunc)
...
type DaemonSetInterface interface {
	...
	AddFeatureLifecycle(enabled func() bool, ctx context.Context, name string, lifecycle DaemonSetLifecycle)
	AddClusterScopedHandler(ctx context.Context, name, clusterName string, sync DaemonSetHandlerFunc)
	AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name, clusterName string, sync DaemonSetHandlerFunc)
	AddClusterScopedLifecycle(ctx context.Context, name, clusterName string, lifecycle DaemonSetLifecycle)
	AddClusterScopedFeatureLifecycle(enabled func() bool, ctx context.Context, name, clusterName string, lifecycle DaemonSetLifecycle)
}
...
func (c *daemonSetController) AddFeatureHandler(enabled func() bool, ctx context.Context, name string, handler DaemonSetHandlerFunc) {
	c.GenericController.AddHandler(ctx, name, func(key string, obj interface{}) (interface{}, error) {
		if !enabled() {
			return nil, nil
		} else if obj == nil {
...
func (c *daemonSetController) AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name, cluster string, handler DaemonSetHandlerFunc) {
	resource.PutClusterScoped(DaemonSetGroupVersionResource)
	c.GenericController.AddHandler(ctx, name, func(key string, obj interface{}) (interface{}, error) {
		if !enabled() {
			return nil, nil
...
func (s *daemonSetClient) AddFeatureHandler(enabled func() bool, ctx context.Context, name string, sync DaemonSetHandlerFunc) {
...
func (s *daemonSetClient) AddFeatureLifecycle(enabled func() bool, ctx context.Context, name string, lifecycle DaemonSetLifecycle) {
	sync := NewDaemonSetLifecycleAdapter(name, false, s, lifecycle)
	s.Controller().AddFeatureHandler(enabled, ctx, name, sync)
}
...
func (s *daemonSetClient) AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name, clusterName string, sync DaemonSetHandlerFunc) {
...
func (s *daemonSetClient) AddClusterScopedFeatureLifecycle(enabled func() bool, ctx context.Context, name, clusterName string, lifecycle DaemonSetLifecycle) {
	sync := NewDaemonSetLifecycleAdapter(name+"_"+clusterName, true, s, lifecycle)
	s.Controller().AddClusterScopedFeatureHandler(enabled, ctx, name, clusterName, sync)
}
