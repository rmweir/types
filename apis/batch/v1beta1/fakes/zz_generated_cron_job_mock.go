...
import (
	...
	v1beta1a "github.com/rancher/types/apis/batch/v1beta1"
...
// Ensure, that CronJobListerMock does implement CronJobLister.
// If this is not the case, regenerate this file with moq.
var _ v1beta1a.CronJobLister = &CronJobListerMock{}
...
// If this is not the case, regenerate this file with moq.
var _ v1beta1a.CronJobController = &CronJobControllerMock{}
...
//             AddClusterScopedFeatureHandlerFunc: func(enabled func() bool, ctx context.Context, name string, clusterName string, handler v1beta1a.CronJobHandlerFunc)  {
...
//             },
//             AddFeatureHandlerFunc: func(enabled func() bool, ctx context.Context, name string, sync v1beta1a.CronJobHandlerFunc)  {
...
func (mock *CronJobControllerMock) AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name string, clusterName string, handler v1beta1a.CronJobHandlerFunc) {
...
func (mock *CronJobControllerMock) AddFeatureHandler(enabled func() bool, ctx context.Context, name string, sync v1beta1a.CronJobHandlerFunc) {
...
func (mock *CronJobControllerMock) Lister() v1beta1a.CronJobLister {
...
// If this is not the case, regenerate this file with moq.
var _ v1beta1a.CronJobInterface = &CronJobInterfaceMock{}
...
//             AddClusterScopedFeatureHandlerFunc: func(enabled func() bool, ctx context.Context, name string, clusterName string, sync v1beta1a.CronJobHandlerFunc)  {
// 	               panic("mock out the AddClusterScopedFeatureHandler method")
//             },
//             AddClusterScopedFeatureLifecycleFunc: func(enabled func() bool, ctx context.Context, name string, clusterName string, lifecycle v1beta1a.CronJobLifecycle)  {
...
// 	               panic("mock out the AddFeatureHandler method")
//             },
//             AddFeatureLifecycleFunc: func(enabled func() bool, ctx context.Context, name string, lifecycle v1beta1a.CronJobLifecycle)  {
...
// AddClusterScopedFeatureHandler calls AddClusterScopedFeatureHandlerFunc.
func (mock *CronJobInterfaceMock) AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name string, clusterName string, sync v1beta1a.CronJobHandlerFunc) {
	if mock.AddClusterScopedFeatureHandlerFunc == nil {
...
func (mock *CronJobInterfaceMock) AddClusterScopedFeatureLifecycle(enabled func() bool, ctx context.Context, name string, clusterName string, lifecycle v1beta1a.CronJobLifecycle) {
...
// AddFeatureHandler calls AddFeatureHandlerFunc.
func (mock *CronJobInterfaceMock) AddFeatureHandler(enabled func() bool, ctx context.Context, name string, sync v1beta1a.CronJobHandlerFunc) {
	if mock.AddFeatureHandlerFunc == nil {
...
func (mock *CronJobInterfaceMock) AddFeatureLifecycle(enabled func() bool, ctx context.Context, name string, lifecycle v1beta1a.CronJobLifecycle) {
...
// Ensure, that CronJobsGetterMock does implement CronJobsGetter.
// If this is not the case, regenerate this file with moq.
var _ v1beta1a.CronJobsGetter = &CronJobsGetterMock{}
