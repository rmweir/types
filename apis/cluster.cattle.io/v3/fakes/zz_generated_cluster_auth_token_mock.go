...
// Ensure, that ClusterAuthTokenListerMock does implement ClusterAuthTokenLister.
// If this is not the case, regenerate this file with moq.
var _ v3.ClusterAuthTokenLister = &ClusterAuthTokenListerMock{}
...
// If this is not the case, regenerate this file with moq.
var _ v3.ClusterAuthTokenController = &ClusterAuthTokenControllerMock{}
...
//             AddClusterScopedFeatureHandlerFunc: func(enabled func() bool, ctx context.Context, name string, clusterName string, handler v3.ClusterAuthTokenHandlerFunc)  {
...
//             },
//             AddFeatureHandlerFunc: func(enabled func() bool, ctx context.Context, name string, sync v3.ClusterAuthTokenHandlerFunc)  {
...
func (mock *ClusterAuthTokenControllerMock) AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name string, clusterName string, handler v3.ClusterAuthTokenHandlerFunc) {
...
func (mock *ClusterAuthTokenControllerMock) AddFeatureHandler(enabled func() bool, ctx context.Context, name string, sync v3.ClusterAuthTokenHandlerFunc) {
...
// If this is not the case, regenerate this file with moq.
var _ v3.ClusterAuthTokenInterface = &ClusterAuthTokenInterfaceMock{}
...
//             AddClusterScopedFeatureHandlerFunc: func(enabled func() bool, ctx context.Context, name string, clusterName string, sync v3.ClusterAuthTokenHandlerFunc)  {
// 	               panic("mock out the AddClusterScopedFeatureHandler method")
//             },
//             AddClusterScopedFeatureLifecycleFunc: func(enabled func() bool, ctx context.Context, name string, clusterName string, lifecycle v3.ClusterAuthTokenLifecycle)  {
...
// 	               panic("mock out the AddFeatureHandler method")
//             },
//             AddFeatureLifecycleFunc: func(enabled func() bool, ctx context.Context, name string, lifecycle v3.ClusterAuthTokenLifecycle)  {
...
// AddClusterScopedFeatureHandler calls AddClusterScopedFeatureHandlerFunc.
func (mock *ClusterAuthTokenInterfaceMock) AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name string, clusterName string, sync v3.ClusterAuthTokenHandlerFunc) {
	if mock.AddClusterScopedFeatureHandlerFunc == nil {
...
func (mock *ClusterAuthTokenInterfaceMock) AddClusterScopedFeatureLifecycle(enabled func() bool, ctx context.Context, name string, clusterName string, lifecycle v3.ClusterAuthTokenLifecycle) {
...
// AddFeatureHandler calls AddFeatureHandlerFunc.
func (mock *ClusterAuthTokenInterfaceMock) AddFeatureHandler(enabled func() bool, ctx context.Context, name string, sync v3.ClusterAuthTokenHandlerFunc) {
	if mock.AddFeatureHandlerFunc == nil {
...
func (mock *ClusterAuthTokenInterfaceMock) AddFeatureLifecycle(enabled func() bool, ctx context.Context, name string, lifecycle v3.ClusterAuthTokenLifecycle) {
...
// Ensure, that ClusterAuthTokensGetterMock does implement ClusterAuthTokensGetter.
// If this is not the case, regenerate this file with moq.
var _ v3.ClusterAuthTokensGetter = &ClusterAuthTokensGetterMock{}
