...
type ReplicationControllerController interface {
	...
	AddFeatureHandler(enabled func() bool, ctx context.Context, name string, sync ReplicationControllerHandlerFunc)
	AddClusterScopedHandler(ctx context.Context, name, clusterName string, handler ReplicationControllerHandlerFunc)
	AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name, clusterName string, handler ReplicationControllerHandlerFunc)
...
type ReplicationControllerInterface interface {
	...
	AddFeatureLifecycle(enabled func() bool, ctx context.Context, name string, lifecycle ReplicationControllerLifecycle)
	AddClusterScopedHandler(ctx context.Context, name, clusterName string, sync ReplicationControllerHandlerFunc)
	AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name, clusterName string, sync ReplicationControllerHandlerFunc)
	AddClusterScopedLifecycle(ctx context.Context, name, clusterName string, lifecycle ReplicationControllerLifecycle)
	AddClusterScopedFeatureLifecycle(enabled func() bool, ctx context.Context, name, clusterName string, lifecycle ReplicationControllerLifecycle)
}
...
func (c *replicationControllerController) AddFeatureHandler(enabled func() bool, ctx context.Context, name string, handler ReplicationControllerHandlerFunc) {
	c.GenericController.AddHandler(ctx, name, func(key string, obj interface{}) (interface{}, error) {
		if !enabled() {
			return nil, nil
		} else if obj == nil {
...
func (c *replicationControllerController) AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name, cluster string, handler ReplicationControllerHandlerFunc) {
	resource.PutClusterScoped(ReplicationControllerGroupVersionResource)
	c.GenericController.AddHandler(ctx, name, func(key string, obj interface{}) (interface{}, error) {
		if !enabled() {
			return nil, nil
...
func (s *replicationControllerClient) AddFeatureHandler(enabled func() bool, ctx context.Context, name string, sync ReplicationControllerHandlerFunc) {
...
func (s *replicationControllerClient) AddFeatureLifecycle(enabled func() bool, ctx context.Context, name string, lifecycle ReplicationControllerLifecycle) {
	sync := NewReplicationControllerLifecycleAdapter(name, false, s, lifecycle)
	s.Controller().AddFeatureHandler(enabled, ctx, name, sync)
}
...
func (s *replicationControllerClient) AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name, clusterName string, sync ReplicationControllerHandlerFunc) {
...
func (s *replicationControllerClient) AddClusterScopedFeatureLifecycle(enabled func() bool, ctx context.Context, name, clusterName string, lifecycle ReplicationControllerLifecycle) {
	sync := NewReplicationControllerLifecycleAdapter(name+"_"+clusterName, true, s, lifecycle)
	s.Controller().AddClusterScopedFeatureHandler(enabled, ctx, name, clusterName, sync)
}
