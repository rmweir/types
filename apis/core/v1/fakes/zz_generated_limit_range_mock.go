...
// Ensure, that LimitRangeListerMock does implement LimitRangeLister.
// If this is not the case, regenerate this file with moq.
var _ v1a.LimitRangeLister = &LimitRangeListerMock{}
...
// If this is not the case, regenerate this file with moq.
var _ v1a.LimitRangeController = &LimitRangeControllerMock{}
...
//             AddClusterScopedFeatureHandlerFunc: func(enabled func() bool, ctx context.Context, name string, clusterName string, handler v1a.LimitRangeHandlerFunc)  {
...
//             },
//             AddFeatureHandlerFunc: func(enabled func() bool, ctx context.Context, name string, sync v1a.LimitRangeHandlerFunc)  {
...
func (mock *LimitRangeControllerMock) AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name string, clusterName string, handler v1a.LimitRangeHandlerFunc) {
...
func (mock *LimitRangeControllerMock) AddFeatureHandler(enabled func() bool, ctx context.Context, name string, sync v1a.LimitRangeHandlerFunc) {
...
func (mock *LimitRangeControllerMock) Lister() v1a.LimitRangeLister {
...
// If this is not the case, regenerate this file with moq.
var _ v1a.LimitRangeInterface = &LimitRangeInterfaceMock{}
...
//             AddClusterScopedFeatureHandlerFunc: func(enabled func() bool, ctx context.Context, name string, clusterName string, sync v1a.LimitRangeHandlerFunc)  {
// 	               panic("mock out the AddClusterScopedFeatureHandler method")
//             },
//             AddClusterScopedFeatureLifecycleFunc: func(enabled func() bool, ctx context.Context, name string, clusterName string, lifecycle v1a.LimitRangeLifecycle)  {
...
// 	               panic("mock out the AddFeatureHandler method")
//             },
//             AddFeatureLifecycleFunc: func(enabled func() bool, ctx context.Context, name string, lifecycle v1a.LimitRangeLifecycle)  {
...
// AddClusterScopedFeatureHandler calls AddClusterScopedFeatureHandlerFunc.
func (mock *LimitRangeInterfaceMock) AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name string, clusterName string, sync v1a.LimitRangeHandlerFunc) {
	if mock.AddClusterScopedFeatureHandlerFunc == nil {
...
func (mock *LimitRangeInterfaceMock) AddClusterScopedFeatureLifecycle(enabled func() bool, ctx context.Context, name string, clusterName string, lifecycle v1a.LimitRangeLifecycle) {
...
// AddFeatureHandler calls AddFeatureHandlerFunc.
func (mock *LimitRangeInterfaceMock) AddFeatureHandler(enabled func() bool, ctx context.Context, name string, sync v1a.LimitRangeHandlerFunc) {
	if mock.AddFeatureHandlerFunc == nil {
...
func (mock *LimitRangeInterfaceMock) AddFeatureLifecycle(enabled func() bool, ctx context.Context, name string, lifecycle v1a.LimitRangeLifecycle) {
...
func (mock *LimitRangeInterfaceMock) Controller() v1a.LimitRangeController {
...
func (mock *LimitRangeInterfaceMock) Watch(opts v1b.ListOptions) (watch.Interface, error) {
...
// Ensure, that LimitRangesGetterMock does implement LimitRangesGetter.
// If this is not the case, regenerate this file with moq.
var _ v1a.LimitRangesGetter = &LimitRangesGetterMock{}
