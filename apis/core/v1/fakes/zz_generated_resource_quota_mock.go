...
// Ensure, that ResourceQuotaListerMock does implement ResourceQuotaLister.
// If this is not the case, regenerate this file with moq.
var _ v1a.ResourceQuotaLister = &ResourceQuotaListerMock{}
...
// If this is not the case, regenerate this file with moq.
var _ v1a.ResourceQuotaController = &ResourceQuotaControllerMock{}
...
//             AddClusterScopedFeatureHandlerFunc: func(enabled func() bool, ctx context.Context, name string, clusterName string, handler v1a.ResourceQuotaHandlerFunc)  {
...
//             },
//             AddFeatureHandlerFunc: func(enabled func() bool, ctx context.Context, name string, sync v1a.ResourceQuotaHandlerFunc)  {
...
func (mock *ResourceQuotaControllerMock) AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name string, clusterName string, handler v1a.ResourceQuotaHandlerFunc) {
...
func (mock *ResourceQuotaControllerMock) AddFeatureHandler(enabled func() bool, ctx context.Context, name string, sync v1a.ResourceQuotaHandlerFunc) {
...
func (mock *ResourceQuotaControllerMock) Lister() v1a.ResourceQuotaLister {
...
// If this is not the case, regenerate this file with moq.
var _ v1a.ResourceQuotaInterface = &ResourceQuotaInterfaceMock{}
...
//             AddClusterScopedFeatureHandlerFunc: func(enabled func() bool, ctx context.Context, name string, clusterName string, sync v1a.ResourceQuotaHandlerFunc)  {
// 	               panic("mock out the AddClusterScopedFeatureHandler method")
//             },
//             AddClusterScopedFeatureLifecycleFunc: func(enabled func() bool, ctx context.Context, name string, clusterName string, lifecycle v1a.ResourceQuotaLifecycle)  {
...
// 	               panic("mock out the AddFeatureHandler method")
//             },
//             AddFeatureLifecycleFunc: func(enabled func() bool, ctx context.Context, name string, lifecycle v1a.ResourceQuotaLifecycle)  {
...
// AddClusterScopedFeatureHandler calls AddClusterScopedFeatureHandlerFunc.
func (mock *ResourceQuotaInterfaceMock) AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name string, clusterName string, sync v1a.ResourceQuotaHandlerFunc) {
	if mock.AddClusterScopedFeatureHandlerFunc == nil {
...
func (mock *ResourceQuotaInterfaceMock) AddClusterScopedFeatureLifecycle(enabled func() bool, ctx context.Context, name string, clusterName string, lifecycle v1a.ResourceQuotaLifecycle) {
...
// AddFeatureHandler calls AddFeatureHandlerFunc.
func (mock *ResourceQuotaInterfaceMock) AddFeatureHandler(enabled func() bool, ctx context.Context, name string, sync v1a.ResourceQuotaHandlerFunc) {
	if mock.AddFeatureHandlerFunc == nil {
...
func (mock *ResourceQuotaInterfaceMock) AddFeatureLifecycle(enabled func() bool, ctx context.Context, name string, lifecycle v1a.ResourceQuotaLifecycle) {
...
// AddHandler calls AddHandlerFunc.
func (mock *ResourceQuotaInterfaceMock) AddHandler(ctx context.Context, name string, sync v1a.ResourceQuotaHandlerFunc) {
	if mock.AddHandlerFunc == nil {
...
func (mock *ResourceQuotaInterfaceMock) Controller() v1a.ResourceQuotaController {
...
// Get calls GetFunc.
func (mock *ResourceQuotaInterfaceMock) Get(name string, opts v1b.GetOptions) (*v1.ResourceQuota, error) {
	if mock.GetFunc == nil {
...
func (mock *ResourceQuotaInterfaceMock) Watch(opts v1b.ListOptions) (watch.Interface, error) {
...
// Ensure, that ResourceQuotasGetterMock does implement ResourceQuotasGetter.
// If this is not the case, regenerate this file with moq.
var _ v1a.ResourceQuotasGetter = &ResourceQuotasGetterMock{}
