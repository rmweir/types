...
//             AddClusterScopedFeatureHandlerFunc: func(enabled func() bool, ctx context.Context, name string, clusterName string, handler v1a.NamespaceHandlerFunc)  {
...
//             },
//             AddFeatureHandlerFunc: func(enabled func() bool, ctx context.Context, name string, sync v1a.NamespaceHandlerFunc)  {
...
func (mock *NamespaceControllerMock) AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name string, clusterName string, handler v1a.NamespaceHandlerFunc) {
...
func (mock *NamespaceControllerMock) AddFeatureHandler(enabled func() bool, ctx context.Context, name string, sync v1a.NamespaceHandlerFunc) {
...
//             AddClusterScopedFeatureHandlerFunc: func(enabled func() bool, ctx context.Context, name string, clusterName string, sync v1a.NamespaceHandlerFunc)  {
// 	               panic("mock out the AddClusterScopedFeatureHandler method")
//             },
//             AddClusterScopedFeatureLifecycleFunc: func(enabled func() bool, ctx context.Context, name string, clusterName string, lifecycle v1a.NamespaceLifecycle)  {
...
// 	               panic("mock out the AddFeatureHandler method")
//             },
//             AddFeatureLifecycleFunc: func(enabled func() bool, ctx context.Context, name string, lifecycle v1a.NamespaceLifecycle)  {
...
// AddClusterScopedFeatureHandler calls AddClusterScopedFeatureHandlerFunc.
func (mock *NamespaceInterfaceMock) AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name string, clusterName string, sync v1a.NamespaceHandlerFunc) {
	if mock.AddClusterScopedFeatureHandlerFunc == nil {
...
func (mock *NamespaceInterfaceMock) AddClusterScopedFeatureLifecycle(enabled func() bool, ctx context.Context, name string, clusterName string, lifecycle v1a.NamespaceLifecycle) {
...
// AddFeatureHandler calls AddFeatureHandlerFunc.
func (mock *NamespaceInterfaceMock) AddFeatureHandler(enabled func() bool, ctx context.Context, name string, sync v1a.NamespaceHandlerFunc) {
	if mock.AddFeatureHandlerFunc == nil {
...
func (mock *NamespaceInterfaceMock) AddFeatureLifecycle(enabled func() bool, ctx context.Context, name string, lifecycle v1a.NamespaceLifecycle) {
