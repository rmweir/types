...
// Ensure, that NodeListerMock does implement NodeLister.
// If this is not the case, regenerate this file with moq.
var _ v1a.NodeLister = &NodeListerMock{}
...
// If this is not the case, regenerate this file with moq.
var _ v1a.NodeController = &NodeControllerMock{}
...
//             AddClusterScopedFeatureHandlerFunc: func(enabled func() bool, ctx context.Context, name string, clusterName string, handler v1a.NodeHandlerFunc)  {
...
//             },
//             AddFeatureHandlerFunc: func(enabled func() bool, ctx context.Context, name string, sync v1a.NodeHandlerFunc)  {
...
func (mock *NodeControllerMock) AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name string, clusterName string, handler v1a.NodeHandlerFunc) {
...
func (mock *NodeControllerMock) AddFeatureHandler(enabled func() bool, ctx context.Context, name string, sync v1a.NodeHandlerFunc) {
...
// If this is not the case, regenerate this file with moq.
var _ v1a.NodeInterface = &NodeInterfaceMock{}
...
//             AddClusterScopedFeatureHandlerFunc: func(enabled func() bool, ctx context.Context, name string, clusterName string, sync v1a.NodeHandlerFunc)  {
// 	               panic("mock out the AddClusterScopedFeatureHandler method")
//             },
//             AddClusterScopedFeatureLifecycleFunc: func(enabled func() bool, ctx context.Context, name string, clusterName string, lifecycle v1a.NodeLifecycle)  {
...
// 	               panic("mock out the AddFeatureHandler method")
//             },
//             AddFeatureLifecycleFunc: func(enabled func() bool, ctx context.Context, name string, lifecycle v1a.NodeLifecycle)  {
...
// AddClusterScopedFeatureHandler calls AddClusterScopedFeatureHandlerFunc.
func (mock *NodeInterfaceMock) AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name string, clusterName string, sync v1a.NodeHandlerFunc) {
	if mock.AddClusterScopedFeatureHandlerFunc == nil {
...
func (mock *NodeInterfaceMock) AddClusterScopedFeatureLifecycle(enabled func() bool, ctx context.Context, name string, clusterName string, lifecycle v1a.NodeLifecycle) {
...
// AddFeatureHandler calls AddFeatureHandlerFunc.
func (mock *NodeInterfaceMock) AddFeatureHandler(enabled func() bool, ctx context.Context, name string, sync v1a.NodeHandlerFunc) {
	if mock.AddFeatureHandlerFunc == nil {
...
func (mock *NodeInterfaceMock) AddFeatureLifecycle(enabled func() bool, ctx context.Context, name string, lifecycle v1a.NodeLifecycle) {
...
// Ensure, that NodesGetterMock does implement NodesGetter.
// If this is not the case, regenerate this file with moq.
var _ v1a.NodesGetter = &NodesGetterMock{}
