...
type ServiceAccountController interface {
	...
	AddFeatureHandler(enabled func() bool, ctx context.Context, name string, sync ServiceAccountHandlerFunc)
	AddClusterScopedHandler(ctx context.Context, name, clusterName string, handler ServiceAccountHandlerFunc)
	AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name, clusterName string, handler ServiceAccountHandlerFunc)
...
type ServiceAccountInterface interface {
	...
	AddFeatureLifecycle(enabled func() bool, ctx context.Context, name string, lifecycle ServiceAccountLifecycle)
	AddClusterScopedHandler(ctx context.Context, name, clusterName string, sync ServiceAccountHandlerFunc)
	AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name, clusterName string, sync ServiceAccountHandlerFunc)
	AddClusterScopedLifecycle(ctx context.Context, name, clusterName string, lifecycle ServiceAccountLifecycle)
	AddClusterScopedFeatureLifecycle(enabled func() bool, ctx context.Context, name, clusterName string, lifecycle ServiceAccountLifecycle)
}
...
func (c *serviceAccountController) AddFeatureHandler(enabled func() bool, ctx context.Context, name string, handler ServiceAccountHandlerFunc) {
	c.GenericController.AddHandler(ctx, name, func(key string, obj interface{}) (interface{}, error) {
		if !enabled() {
			return nil, nil
		} else if obj == nil {
...
func (c *serviceAccountController) AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name, cluster string, handler ServiceAccountHandlerFunc) {
	resource.PutClusterScoped(ServiceAccountGroupVersionResource)
	c.GenericController.AddHandler(ctx, name, func(key string, obj interface{}) (interface{}, error) {
		if !enabled() {
			return nil, nil
...
func (s *serviceAccountClient) AddFeatureHandler(enabled func() bool, ctx context.Context, name string, sync ServiceAccountHandlerFunc) {
...
func (s *serviceAccountClient) AddFeatureLifecycle(enabled func() bool, ctx context.Context, name string, lifecycle ServiceAccountLifecycle) {
	sync := NewServiceAccountLifecycleAdapter(name, false, s, lifecycle)
	s.Controller().AddFeatureHandler(enabled, ctx, name, sync)
}
...
func (s *serviceAccountClient) AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name, clusterName string, sync ServiceAccountHandlerFunc) {
...
func (s *serviceAccountClient) AddClusterScopedFeatureLifecycle(enabled func() bool, ctx context.Context, name, clusterName string, lifecycle ServiceAccountLifecycle) {
	sync := NewServiceAccountLifecycleAdapter(name+"_"+clusterName, true, s, lifecycle)
	s.Controller().AddClusterScopedFeatureHandler(enabled, ctx, name, clusterName, sync)
}
