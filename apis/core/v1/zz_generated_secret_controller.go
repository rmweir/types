...
type SecretController interface {
	...
	AddFeatureHandler(enabled func() bool, ctx context.Context, name string, sync SecretHandlerFunc)
	AddClusterScopedHandler(ctx context.Context, name, clusterName string, handler SecretHandlerFunc)
	AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name, clusterName string, handler SecretHandlerFunc)
...
type SecretInterface interface {
	...
	AddFeatureLifecycle(enabled func() bool, ctx context.Context, name string, lifecycle SecretLifecycle)
	AddClusterScopedHandler(ctx context.Context, name, clusterName string, sync SecretHandlerFunc)
	AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name, clusterName string, sync SecretHandlerFunc)
	AddClusterScopedLifecycle(ctx context.Context, name, clusterName string, lifecycle SecretLifecycle)
	AddClusterScopedFeatureLifecycle(enabled func() bool, ctx context.Context, name, clusterName string, lifecycle SecretLifecycle)
}
...
func (c *secretController) AddFeatureHandler(enabled func() bool, ctx context.Context, name string, handler SecretHandlerFunc) {
	c.GenericController.AddHandler(ctx, name, func(key string, obj interface{}) (interface{}, error) {
		if !enabled() {
			return nil, nil
		} else if obj == nil {
...
func (c *secretController) AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name, cluster string, handler SecretHandlerFunc) {
	resource.PutClusterScoped(SecretGroupVersionResource)
	c.GenericController.AddHandler(ctx, name, func(key string, obj interface{}) (interface{}, error) {
		if !enabled() {
			return nil, nil
...
func (s *secretClient) AddFeatureHandler(enabled func() bool, ctx context.Context, name string, sync SecretHandlerFunc) {
...
func (s *secretClient) AddFeatureLifecycle(enabled func() bool, ctx context.Context, name string, lifecycle SecretLifecycle) {
	sync := NewSecretLifecycleAdapter(name, false, s, lifecycle)
	s.Controller().AddFeatureHandler(enabled, ctx, name, sync)
}
...
func (s *secretClient) AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name, clusterName string, sync SecretHandlerFunc) {
...
func (s *secretClient) AddClusterScopedFeatureLifecycle(enabled func() bool, ctx context.Context, name, clusterName string, lifecycle SecretLifecycle) {
	sync := NewSecretLifecycleAdapter(name+"_"+clusterName, true, s, lifecycle)
	s.Controller().AddClusterScopedFeatureHandler(enabled, ctx, name, clusterName, sync)
}
