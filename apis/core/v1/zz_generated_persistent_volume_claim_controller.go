...
type PersistentVolumeClaimController interface {
	...
	AddFeatureHandler(enabled func() bool, ctx context.Context, name string, sync PersistentVolumeClaimHandlerFunc)
	AddClusterScopedHandler(ctx context.Context, name, clusterName string, handler PersistentVolumeClaimHandlerFunc)
	AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name, clusterName string, handler PersistentVolumeClaimHandlerFunc)
...
type PersistentVolumeClaimInterface interface {
	...
	AddFeatureLifecycle(enabled func() bool, ctx context.Context, name string, lifecycle PersistentVolumeClaimLifecycle)
	AddClusterScopedHandler(ctx context.Context, name, clusterName string, sync PersistentVolumeClaimHandlerFunc)
	AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name, clusterName string, sync PersistentVolumeClaimHandlerFunc)
	AddClusterScopedLifecycle(ctx context.Context, name, clusterName string, lifecycle PersistentVolumeClaimLifecycle)
	AddClusterScopedFeatureLifecycle(enabled func() bool, ctx context.Context, name, clusterName string, lifecycle PersistentVolumeClaimLifecycle)
}
...
func (c *persistentVolumeClaimController) AddFeatureHandler(enabled func() bool, ctx context.Context, name string, handler PersistentVolumeClaimHandlerFunc) {
	c.GenericController.AddHandler(ctx, name, func(key string, obj interface{}) (interface{}, error) {
		if !enabled() {
			return nil, nil
		} else if obj == nil {
...
func (c *persistentVolumeClaimController) AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name, cluster string, handler PersistentVolumeClaimHandlerFunc) {
	resource.PutClusterScoped(PersistentVolumeClaimGroupVersionResource)
	c.GenericController.AddHandler(ctx, name, func(key string, obj interface{}) (interface{}, error) {
		if !enabled() {
			return nil, nil
...
func (s *persistentVolumeClaimClient) AddFeatureHandler(enabled func() bool, ctx context.Context, name string, sync PersistentVolumeClaimHandlerFunc) {
...
func (s *persistentVolumeClaimClient) AddFeatureLifecycle(enabled func() bool, ctx context.Context, name string, lifecycle PersistentVolumeClaimLifecycle) {
	sync := NewPersistentVolumeClaimLifecycleAdapter(name, false, s, lifecycle)
	s.Controller().AddFeatureHandler(enabled, ctx, name, sync)
}
...
func (s *persistentVolumeClaimClient) AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name, clusterName string, sync PersistentVolumeClaimHandlerFunc) {
...
func (s *persistentVolumeClaimClient) AddClusterScopedFeatureLifecycle(enabled func() bool, ctx context.Context, name, clusterName string, lifecycle PersistentVolumeClaimLifecycle) {
	sync := NewPersistentVolumeClaimLifecycleAdapter(name+"_"+clusterName, true, s, lifecycle)
	s.Controller().AddClusterScopedFeatureHandler(enabled, ctx, name, clusterName, sync)
}
