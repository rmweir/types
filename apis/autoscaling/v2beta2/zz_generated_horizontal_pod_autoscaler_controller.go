...
type HorizontalPodAutoscalerController interface {
	...
	AddFeatureHandler(enabled func() bool, ctx context.Context, name string, sync HorizontalPodAutoscalerHandlerFunc)
	AddClusterScopedHandler(ctx context.Context, name, clusterName string, handler HorizontalPodAutoscalerHandlerFunc)
	AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name, clusterName string, handler HorizontalPodAutoscalerHandlerFunc)
...
type HorizontalPodAutoscalerInterface interface {
	...
	AddFeatureLifecycle(enabled func() bool, ctx context.Context, name string, lifecycle HorizontalPodAutoscalerLifecycle)
	AddClusterScopedHandler(ctx context.Context, name, clusterName string, sync HorizontalPodAutoscalerHandlerFunc)
	AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name, clusterName string, sync HorizontalPodAutoscalerHandlerFunc)
	AddClusterScopedLifecycle(ctx context.Context, name, clusterName string, lifecycle HorizontalPodAutoscalerLifecycle)
	AddClusterScopedFeatureLifecycle(enabled func() bool, ctx context.Context, name, clusterName string, lifecycle HorizontalPodAutoscalerLifecycle)
}
...
func (c *horizontalPodAutoscalerController) AddFeatureHandler(enabled func() bool, ctx context.Context, name string, handler HorizontalPodAutoscalerHandlerFunc) {
	c.GenericController.AddHandler(ctx, name, func(key string, obj interface{}) (interface{}, error) {
		if !enabled() {
			return nil, nil
		} else if obj == nil {
...
func (c *horizontalPodAutoscalerController) AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name, cluster string, handler HorizontalPodAutoscalerHandlerFunc) {
	resource.PutClusterScoped(HorizontalPodAutoscalerGroupVersionResource)
	c.GenericController.AddHandler(ctx, name, func(key string, obj interface{}) (interface{}, error) {
		if !enabled() {
			return nil, nil
...
func (s *horizontalPodAutoscalerClient) AddFeatureHandler(enabled func() bool, ctx context.Context, name string, sync HorizontalPodAutoscalerHandlerFunc) {
...
func (s *horizontalPodAutoscalerClient) AddFeatureLifecycle(enabled func() bool, ctx context.Context, name string, lifecycle HorizontalPodAutoscalerLifecycle) {
	sync := NewHorizontalPodAutoscalerLifecycleAdapter(name, false, s, lifecycle)
	s.Controller().AddFeatureHandler(enabled, ctx, name, sync)
}
...
func (s *horizontalPodAutoscalerClient) AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name, clusterName string, sync HorizontalPodAutoscalerHandlerFunc) {
...
func (s *horizontalPodAutoscalerClient) AddClusterScopedFeatureLifecycle(enabled func() bool, ctx context.Context, name, clusterName string, lifecycle HorizontalPodAutoscalerLifecycle) {
	sync := NewHorizontalPodAutoscalerLifecycleAdapter(name+"_"+clusterName, true, s, lifecycle)
	s.Controller().AddClusterScopedFeatureHandler(enabled, ctx, name, clusterName, sync)
}
