...
// Ensure, that PrometheusListerMock does implement PrometheusLister.
// If this is not the case, regenerate this file with moq.
var _ v1a.PrometheusLister = &PrometheusListerMock{}
...
// If this is not the case, regenerate this file with moq.
var _ v1a.PrometheusController = &PrometheusControllerMock{}
...
//             AddClusterScopedFeatureHandlerFunc: func(enabled func() bool, ctx context.Context, name string, clusterName string, handler v1a.PrometheusHandlerFunc)  {
...
//             },
//             AddFeatureHandlerFunc: func(enabled func() bool, ctx context.Context, name string, sync v1a.PrometheusHandlerFunc)  {
...
func (mock *PrometheusControllerMock) AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name string, clusterName string, handler v1a.PrometheusHandlerFunc) {
...
func (mock *PrometheusControllerMock) AddFeatureHandler(enabled func() bool, ctx context.Context, name string, sync v1a.PrometheusHandlerFunc) {
...
func (mock *PrometheusControllerMock) Lister() v1a.PrometheusLister {
...
// Ensure, that PrometheusInterfaceMock does implement PrometheusInterface.
// If this is not the case, regenerate this file with moq.
var _ v1a.PrometheusInterface = &PrometheusInterfaceMock{}
...
//             AddClusterScopedFeatureHandlerFunc: func(enabled func() bool, ctx context.Context, name string, clusterName string, sync v1a.PrometheusHandlerFunc)  {
// 	               panic("mock out the AddClusterScopedFeatureHandler method")
//             },
//             AddClusterScopedFeatureLifecycleFunc: func(enabled func() bool, ctx context.Context, name string, clusterName string, lifecycle v1a.PrometheusLifecycle)  {
...
// 	               panic("mock out the AddFeatureHandler method")
//             },
//             AddFeatureLifecycleFunc: func(enabled func() bool, ctx context.Context, name string, lifecycle v1a.PrometheusLifecycle)  {
...
// AddClusterScopedFeatureHandler calls AddClusterScopedFeatureHandlerFunc.
func (mock *PrometheusInterfaceMock) AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name string, clusterName string, sync v1a.PrometheusHandlerFunc) {
	if mock.AddClusterScopedFeatureHandlerFunc == nil {
...
func (mock *PrometheusInterfaceMock) AddClusterScopedFeatureLifecycle(enabled func() bool, ctx context.Context, name string, clusterName string, lifecycle v1a.PrometheusLifecycle) {
...
// AddFeatureHandler calls AddFeatureHandlerFunc.
func (mock *PrometheusInterfaceMock) AddFeatureHandler(enabled func() bool, ctx context.Context, name string, sync v1a.PrometheusHandlerFunc) {
	if mock.AddFeatureHandlerFunc == nil {
...
func (mock *PrometheusInterfaceMock) AddFeatureLifecycle(enabled func() bool, ctx context.Context, name string, lifecycle v1a.PrometheusLifecycle) {
...
func (mock *PrometheusInterfaceMock) Controller() v1a.PrometheusController {
...
func (mock *PrometheusInterfaceMock) Watch(opts v1b.ListOptions) (watch.Interface, error) {
...
// Ensure, that PrometheusesGetterMock does implement PrometheusesGetter.
// If this is not the case, regenerate this file with moq.
var _ v1a.PrometheusesGetter = &PrometheusesGetterMock{}
