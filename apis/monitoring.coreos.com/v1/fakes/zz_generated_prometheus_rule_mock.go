...
// Ensure, that PrometheusRuleListerMock does implement PrometheusRuleLister.
// If this is not the case, regenerate this file with moq.
var _ v1a.PrometheusRuleLister = &PrometheusRuleListerMock{}
...
// If this is not the case, regenerate this file with moq.
var _ v1a.PrometheusRuleController = &PrometheusRuleControllerMock{}
...
//             AddClusterScopedFeatureHandlerFunc: func(enabled func() bool, ctx context.Context, name string, clusterName string, handler v1a.PrometheusRuleHandlerFunc)  {
...
//             },
//             AddFeatureHandlerFunc: func(enabled func() bool, ctx context.Context, name string, sync v1a.PrometheusRuleHandlerFunc)  {
...
func (mock *PrometheusRuleControllerMock) AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name string, clusterName string, handler v1a.PrometheusRuleHandlerFunc) {
...
func (mock *PrometheusRuleControllerMock) AddFeatureHandler(enabled func() bool, ctx context.Context, name string, sync v1a.PrometheusRuleHandlerFunc) {
...
func (mock *PrometheusRuleControllerMock) Lister() v1a.PrometheusRuleLister {
...
// Ensure, that PrometheusRuleInterfaceMock does implement PrometheusRuleInterface.
// If this is not the case, regenerate this file with moq.
var _ v1a.PrometheusRuleInterface = &PrometheusRuleInterfaceMock{}
...
//             AddClusterScopedFeatureHandlerFunc: func(enabled func() bool, ctx context.Context, name string, clusterName string, sync v1a.PrometheusRuleHandlerFunc)  {
// 	               panic("mock out the AddClusterScopedFeatureHandler method")
//             },
//             AddClusterScopedFeatureLifecycleFunc: func(enabled func() bool, ctx context.Context, name string, clusterName string, lifecycle v1a.PrometheusRuleLifecycle)  {
...
// 	               panic("mock out the AddFeatureHandler method")
//             },
//             AddFeatureLifecycleFunc: func(enabled func() bool, ctx context.Context, name string, lifecycle v1a.PrometheusRuleLifecycle)  {
...
// AddClusterScopedFeatureHandler calls AddClusterScopedFeatureHandlerFunc.
func (mock *PrometheusRuleInterfaceMock) AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name string, clusterName string, sync v1a.PrometheusRuleHandlerFunc) {
	if mock.AddClusterScopedFeatureHandlerFunc == nil {
...
func (mock *PrometheusRuleInterfaceMock) AddClusterScopedFeatureLifecycle(enabled func() bool, ctx context.Context, name string, clusterName string, lifecycle v1a.PrometheusRuleLifecycle) {
...
// AddFeatureHandler calls AddFeatureHandlerFunc.
func (mock *PrometheusRuleInterfaceMock) AddFeatureHandler(enabled func() bool, ctx context.Context, name string, sync v1a.PrometheusRuleHandlerFunc) {
	if mock.AddFeatureHandlerFunc == nil {
...
func (mock *PrometheusRuleInterfaceMock) AddFeatureLifecycle(enabled func() bool, ctx context.Context, name string, lifecycle v1a.PrometheusRuleLifecycle) {
...
// AddHandler calls AddHandlerFunc.
func (mock *PrometheusRuleInterfaceMock) AddHandler(ctx context.Context, name string, sync v1a.PrometheusRuleHandlerFunc) {
	if mock.AddHandlerFunc == nil {
...
func (mock *PrometheusRuleInterfaceMock) Controller() v1a.PrometheusRuleController {
...
// Get calls GetFunc.
func (mock *PrometheusRuleInterfaceMock) Get(name string, opts v1b.GetOptions) (*v1.PrometheusRule, error) {
	if mock.GetFunc == nil {
...
func (mock *PrometheusRuleInterfaceMock) Watch(opts v1b.ListOptions) (watch.Interface, error) {
...
// Ensure, that PrometheusRulesGetterMock does implement PrometheusRulesGetter.
// If this is not the case, regenerate this file with moq.
var _ v1a.PrometheusRulesGetter = &PrometheusRulesGetterMock{}
