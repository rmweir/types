...
type ServiceMonitorController interface {
	...
	AddFeatureHandler(enabled func() bool, ctx context.Context, name string, sync ServiceMonitorHandlerFunc)
	AddClusterScopedHandler(ctx context.Context, name, clusterName string, handler ServiceMonitorHandlerFunc)
	AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name, clusterName string, handler ServiceMonitorHandlerFunc)
...
type ServiceMonitorInterface interface {
	...
	AddFeatureLifecycle(enabled func() bool, ctx context.Context, name string, lifecycle ServiceMonitorLifecycle)
	AddClusterScopedHandler(ctx context.Context, name, clusterName string, sync ServiceMonitorHandlerFunc)
	AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name, clusterName string, sync ServiceMonitorHandlerFunc)
	AddClusterScopedLifecycle(ctx context.Context, name, clusterName string, lifecycle ServiceMonitorLifecycle)
	AddClusterScopedFeatureLifecycle(enabled func() bool, ctx context.Context, name, clusterName string, lifecycle ServiceMonitorLifecycle)
}
...
func (c *serviceMonitorController) AddFeatureHandler(enabled func() bool, ctx context.Context, name string, handler ServiceMonitorHandlerFunc) {
	c.GenericController.AddHandler(ctx, name, func(key string, obj interface{}) (interface{}, error) {
		if !enabled() {
			return nil, nil
		} else if obj == nil {
...
func (c *serviceMonitorController) AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name, cluster string, handler ServiceMonitorHandlerFunc) {
	resource.PutClusterScoped(ServiceMonitorGroupVersionResource)
	c.GenericController.AddHandler(ctx, name, func(key string, obj interface{}) (interface{}, error) {
		if !enabled() {
			return nil, nil
...
func (s *serviceMonitorClient) AddFeatureHandler(enabled func() bool, ctx context.Context, name string, sync ServiceMonitorHandlerFunc) {
...
func (s *serviceMonitorClient) AddFeatureLifecycle(enabled func() bool, ctx context.Context, name string, lifecycle ServiceMonitorLifecycle) {
	sync := NewServiceMonitorLifecycleAdapter(name, false, s, lifecycle)
	s.Controller().AddFeatureHandler(enabled, ctx, name, sync)
}
...
func (s *serviceMonitorClient) AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name, clusterName string, sync ServiceMonitorHandlerFunc) {
...
func (s *serviceMonitorClient) AddClusterScopedFeatureLifecycle(enabled func() bool, ctx context.Context, name, clusterName string, lifecycle ServiceMonitorLifecycle) {
	sync := NewServiceMonitorLifecycleAdapter(name+"_"+clusterName, true, s, lifecycle)
	s.Controller().AddClusterScopedFeatureHandler(enabled, ctx, name, clusterName, sync)
}
