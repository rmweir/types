...
type NamespacedServiceAccountTokenController interface {
	...
	AddFeatureHandler(enabled func() bool, ctx context.Context, name string, sync NamespacedServiceAccountTokenHandlerFunc)
	AddClusterScopedHandler(ctx context.Context, name, clusterName string, handler NamespacedServiceAccountTokenHandlerFunc)
	AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name, clusterName string, handler NamespacedServiceAccountTokenHandlerFunc)
...
type NamespacedServiceAccountTokenInterface interface {
	...
	AddFeatureLifecycle(enabled func() bool, ctx context.Context, name string, lifecycle NamespacedServiceAccountTokenLifecycle)
	AddClusterScopedHandler(ctx context.Context, name, clusterName string, sync NamespacedServiceAccountTokenHandlerFunc)
	AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name, clusterName string, sync NamespacedServiceAccountTokenHandlerFunc)
	AddClusterScopedLifecycle(ctx context.Context, name, clusterName string, lifecycle NamespacedServiceAccountTokenLifecycle)
	AddClusterScopedFeatureLifecycle(enabled func() bool, ctx context.Context, name, clusterName string, lifecycle NamespacedServiceAccountTokenLifecycle)
}
...
func (c *namespacedServiceAccountTokenController) AddFeatureHandler(enabled func() bool, ctx context.Context, name string, handler NamespacedServiceAccountTokenHandlerFunc) {
	c.GenericController.AddHandler(ctx, name, func(key string, obj interface{}) (interface{}, error) {
		if !enabled() {
			return nil, nil
		} else if obj == nil {
...
func (c *namespacedServiceAccountTokenController) AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name, cluster string, handler NamespacedServiceAccountTokenHandlerFunc) {
	resource.PutClusterScoped(NamespacedServiceAccountTokenGroupVersionResource)
	c.GenericController.AddHandler(ctx, name, func(key string, obj interface{}) (interface{}, error) {
		if !enabled() {
			return nil, nil
...
func (s *namespacedServiceAccountTokenClient) AddFeatureHandler(enabled func() bool, ctx context.Context, name string, sync NamespacedServiceAccountTokenHandlerFunc) {
...
func (s *namespacedServiceAccountTokenClient) AddFeatureLifecycle(enabled func() bool, ctx context.Context, name string, lifecycle NamespacedServiceAccountTokenLifecycle) {
	sync := NewNamespacedServiceAccountTokenLifecycleAdapter(name, false, s, lifecycle)
	s.Controller().AddFeatureHandler(enabled, ctx, name, sync)
}
...
func (s *namespacedServiceAccountTokenClient) AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name, clusterName string, sync NamespacedServiceAccountTokenHandlerFunc) {
...
func (s *namespacedServiceAccountTokenClient) AddClusterScopedFeatureLifecycle(enabled func() bool, ctx context.Context, name, clusterName string, lifecycle NamespacedServiceAccountTokenLifecycle) {
	sync := NewNamespacedServiceAccountTokenLifecycleAdapter(name+"_"+clusterName, true, s, lifecycle)
	s.Controller().AddClusterScopedFeatureHandler(enabled, ctx, name, clusterName, sync)
}
