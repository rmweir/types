...
type SourceCodeCredentialController interface {
	...
	AddFeatureHandler(enabled func() bool, ctx context.Context, name string, sync SourceCodeCredentialHandlerFunc)
	AddClusterScopedHandler(ctx context.Context, name, clusterName string, handler SourceCodeCredentialHandlerFunc)
	AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name, clusterName string, handler SourceCodeCredentialHandlerFunc)
...
type SourceCodeCredentialInterface interface {
	...
	AddFeatureLifecycle(enabled func() bool, ctx context.Context, name string, lifecycle SourceCodeCredentialLifecycle)
	AddClusterScopedHandler(ctx context.Context, name, clusterName string, sync SourceCodeCredentialHandlerFunc)
	AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name, clusterName string, sync SourceCodeCredentialHandlerFunc)
	AddClusterScopedLifecycle(ctx context.Context, name, clusterName string, lifecycle SourceCodeCredentialLifecycle)
	AddClusterScopedFeatureLifecycle(enabled func() bool, ctx context.Context, name, clusterName string, lifecycle SourceCodeCredentialLifecycle)
}
...
func (c *sourceCodeCredentialController) AddFeatureHandler(enabled func() bool, ctx context.Context, name string, handler SourceCodeCredentialHandlerFunc) {
	c.GenericController.AddHandler(ctx, name, func(key string, obj interface{}) (interface{}, error) {
		if !enabled() {
			return nil, nil
		} else if obj == nil {
...
func (c *sourceCodeCredentialController) AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name, cluster string, handler SourceCodeCredentialHandlerFunc) {
	resource.PutClusterScoped(SourceCodeCredentialGroupVersionResource)
	c.GenericController.AddHandler(ctx, name, func(key string, obj interface{}) (interface{}, error) {
		if !enabled() {
			return nil, nil
...
func (s *sourceCodeCredentialClient) AddFeatureHandler(enabled func() bool, ctx context.Context, name string, sync SourceCodeCredentialHandlerFunc) {
...
func (s *sourceCodeCredentialClient) AddFeatureLifecycle(enabled func() bool, ctx context.Context, name string, lifecycle SourceCodeCredentialLifecycle) {
	sync := NewSourceCodeCredentialLifecycleAdapter(name, false, s, lifecycle)
	s.Controller().AddFeatureHandler(enabled, ctx, name, sync)
}
...
func (s *sourceCodeCredentialClient) AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name, clusterName string, sync SourceCodeCredentialHandlerFunc) {
...
func (s *sourceCodeCredentialClient) AddClusterScopedFeatureLifecycle(enabled func() bool, ctx context.Context, name, clusterName string, lifecycle SourceCodeCredentialLifecycle) {
	sync := NewSourceCodeCredentialLifecycleAdapter(name+"_"+clusterName, true, s, lifecycle)
	s.Controller().AddClusterScopedFeatureHandler(enabled, ctx, name, clusterName, sync)
}
