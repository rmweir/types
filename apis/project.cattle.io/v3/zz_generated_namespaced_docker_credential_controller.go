...
type NamespacedDockerCredentialController interface {
	...
	AddFeatureHandler(enabled func() bool, ctx context.Context, name string, sync NamespacedDockerCredentialHandlerFunc)
	AddClusterScopedHandler(ctx context.Context, name, clusterName string, handler NamespacedDockerCredentialHandlerFunc)
	AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name, clusterName string, handler NamespacedDockerCredentialHandlerFunc)
...
type NamespacedDockerCredentialInterface interface {
	...
	AddFeatureLifecycle(enabled func() bool, ctx context.Context, name string, lifecycle NamespacedDockerCredentialLifecycle)
	AddClusterScopedHandler(ctx context.Context, name, clusterName string, sync NamespacedDockerCredentialHandlerFunc)
	AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name, clusterName string, sync NamespacedDockerCredentialHandlerFunc)
	AddClusterScopedLifecycle(ctx context.Context, name, clusterName string, lifecycle NamespacedDockerCredentialLifecycle)
	AddClusterScopedFeatureLifecycle(enabled func() bool, ctx context.Context, name, clusterName string, lifecycle NamespacedDockerCredentialLifecycle)
}
...
func (c *namespacedDockerCredentialController) AddFeatureHandler(enabled func() bool, ctx context.Context, name string, handler NamespacedDockerCredentialHandlerFunc) {
	c.GenericController.AddHandler(ctx, name, func(key string, obj interface{}) (interface{}, error) {
		if !enabled() {
			return nil, nil
		} else if obj == nil {
...
func (c *namespacedDockerCredentialController) AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name, cluster string, handler NamespacedDockerCredentialHandlerFunc) {
	resource.PutClusterScoped(NamespacedDockerCredentialGroupVersionResource)
	c.GenericController.AddHandler(ctx, name, func(key string, obj interface{}) (interface{}, error) {
		if !enabled() {
			return nil, nil
...
func (s *namespacedDockerCredentialClient) AddFeatureHandler(enabled func() bool, ctx context.Context, name string, sync NamespacedDockerCredentialHandlerFunc) {
...
func (s *namespacedDockerCredentialClient) AddFeatureLifecycle(enabled func() bool, ctx context.Context, name string, lifecycle NamespacedDockerCredentialLifecycle) {
	sync := NewNamespacedDockerCredentialLifecycleAdapter(name, false, s, lifecycle)
	s.Controller().AddFeatureHandler(enabled, ctx, name, sync)
}
...
func (s *namespacedDockerCredentialClient) AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name, clusterName string, sync NamespacedDockerCredentialHandlerFunc) {
...
func (s *namespacedDockerCredentialClient) AddClusterScopedFeatureLifecycle(enabled func() bool, ctx context.Context, name, clusterName string, lifecycle NamespacedDockerCredentialLifecycle) {
	sync := NewNamespacedDockerCredentialLifecycleAdapter(name+"_"+clusterName, true, s, lifecycle)
	s.Controller().AddClusterScopedFeatureHandler(enabled, ctx, name, clusterName, sync)
}
