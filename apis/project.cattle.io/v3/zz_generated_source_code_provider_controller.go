...
type SourceCodeProviderController interface {
	...
	AddFeatureHandler(enabled func() bool, ctx context.Context, name string, sync SourceCodeProviderHandlerFunc)
	AddClusterScopedHandler(ctx context.Context, name, clusterName string, handler SourceCodeProviderHandlerFunc)
	AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name, clusterName string, handler SourceCodeProviderHandlerFunc)
...
type SourceCodeProviderInterface interface {
	...
	AddFeatureLifecycle(enabled func() bool, ctx context.Context, name string, lifecycle SourceCodeProviderLifecycle)
	AddClusterScopedHandler(ctx context.Context, name, clusterName string, sync SourceCodeProviderHandlerFunc)
	AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name, clusterName string, sync SourceCodeProviderHandlerFunc)
	AddClusterScopedLifecycle(ctx context.Context, name, clusterName string, lifecycle SourceCodeProviderLifecycle)
	AddClusterScopedFeatureLifecycle(enabled func() bool, ctx context.Context, name, clusterName string, lifecycle SourceCodeProviderLifecycle)
}
...
func (c *sourceCodeProviderController) AddFeatureHandler(enabled func() bool, ctx context.Context, name string, handler SourceCodeProviderHandlerFunc) {
	c.GenericController.AddHandler(ctx, name, func(key string, obj interface{}) (interface{}, error) {
		if !enabled() {
			return nil, nil
		} else if obj == nil {
...
func (c *sourceCodeProviderController) AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name, cluster string, handler SourceCodeProviderHandlerFunc) {
	resource.PutClusterScoped(SourceCodeProviderGroupVersionResource)
	c.GenericController.AddHandler(ctx, name, func(key string, obj interface{}) (interface{}, error) {
		if !enabled() {
			return nil, nil
...
func (s *sourceCodeProviderClient) AddFeatureHandler(enabled func() bool, ctx context.Context, name string, sync SourceCodeProviderHandlerFunc) {
...
func (s *sourceCodeProviderClient) AddFeatureLifecycle(enabled func() bool, ctx context.Context, name string, lifecycle SourceCodeProviderLifecycle) {
	sync := NewSourceCodeProviderLifecycleAdapter(name, false, s, lifecycle)
	s.Controller().AddFeatureHandler(enabled, ctx, name, sync)
}
...
func (s *sourceCodeProviderClient) AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name, clusterName string, sync SourceCodeProviderHandlerFunc) {
...
func (s *sourceCodeProviderClient) AddClusterScopedFeatureLifecycle(enabled func() bool, ctx context.Context, name, clusterName string, lifecycle SourceCodeProviderLifecycle) {
	sync := NewSourceCodeProviderLifecycleAdapter(name+"_"+clusterName, true, s, lifecycle)
	s.Controller().AddClusterScopedFeatureHandler(enabled, ctx, name, clusterName, sync)
}
