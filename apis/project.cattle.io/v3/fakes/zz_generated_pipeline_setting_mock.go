...
// Ensure, that PipelineSettingListerMock does implement PipelineSettingLister.
// If this is not the case, regenerate this file with moq.
var _ v3.PipelineSettingLister = &PipelineSettingListerMock{}
...
// If this is not the case, regenerate this file with moq.
var _ v3.PipelineSettingController = &PipelineSettingControllerMock{}
...
//             AddClusterScopedFeatureHandlerFunc: func(enabled func() bool, ctx context.Context, name string, clusterName string, handler v3.PipelineSettingHandlerFunc)  {
...
//             },
//             AddFeatureHandlerFunc: func(enabled func() bool, ctx context.Context, name string, sync v3.PipelineSettingHandlerFunc)  {
...
func (mock *PipelineSettingControllerMock) AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name string, clusterName string, handler v3.PipelineSettingHandlerFunc) {
...
func (mock *PipelineSettingControllerMock) AddFeatureHandler(enabled func() bool, ctx context.Context, name string, sync v3.PipelineSettingHandlerFunc) {
...
// Ensure, that PipelineSettingInterfaceMock does implement PipelineSettingInterface.
// If this is not the case, regenerate this file with moq.
var _ v3.PipelineSettingInterface = &PipelineSettingInterfaceMock{}
...
//             AddClusterScopedFeatureHandlerFunc: func(enabled func() bool, ctx context.Context, name string, clusterName string, sync v3.PipelineSettingHandlerFunc)  {
// 	               panic("mock out the AddClusterScopedFeatureHandler method")
//             },
//             AddClusterScopedFeatureLifecycleFunc: func(enabled func() bool, ctx context.Context, name string, clusterName string, lifecycle v3.PipelineSettingLifecycle)  {
...
// 	               panic("mock out the AddFeatureHandler method")
//             },
//             AddFeatureLifecycleFunc: func(enabled func() bool, ctx context.Context, name string, lifecycle v3.PipelineSettingLifecycle)  {
...
// AddClusterScopedFeatureHandler calls AddClusterScopedFeatureHandlerFunc.
func (mock *PipelineSettingInterfaceMock) AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name string, clusterName string, sync v3.PipelineSettingHandlerFunc) {
	if mock.AddClusterScopedFeatureHandlerFunc == nil {
...
func (mock *PipelineSettingInterfaceMock) AddClusterScopedFeatureLifecycle(enabled func() bool, ctx context.Context, name string, clusterName string, lifecycle v3.PipelineSettingLifecycle) {
...
// AddFeatureHandler calls AddFeatureHandlerFunc.
func (mock *PipelineSettingInterfaceMock) AddFeatureHandler(enabled func() bool, ctx context.Context, name string, sync v3.PipelineSettingHandlerFunc) {
	if mock.AddFeatureHandlerFunc == nil {
...
func (mock *PipelineSettingInterfaceMock) AddFeatureLifecycle(enabled func() bool, ctx context.Context, name string, lifecycle v3.PipelineSettingLifecycle) {
...
// Ensure, that PipelineSettingsGetterMock does implement PipelineSettingsGetter.
// If this is not the case, regenerate this file with moq.
var _ v3.PipelineSettingsGetter = &PipelineSettingsGetterMock{}
