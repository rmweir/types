...
// Ensure, that ServiceAccountTokenListerMock does implement ServiceAccountTokenLister.
// If this is not the case, regenerate this file with moq.
var _ v3.ServiceAccountTokenLister = &ServiceAccountTokenListerMock{}
...
// If this is not the case, regenerate this file with moq.
var _ v3.ServiceAccountTokenController = &ServiceAccountTokenControllerMock{}
...
//             AddClusterScopedFeatureHandlerFunc: func(enabled func() bool, ctx context.Context, name string, clusterName string, handler v3.ServiceAccountTokenHandlerFunc)  {
...
//             },
//             AddFeatureHandlerFunc: func(enabled func() bool, ctx context.Context, name string, sync v3.ServiceAccountTokenHandlerFunc)  {
...
func (mock *ServiceAccountTokenControllerMock) AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name string, clusterName string, handler v3.ServiceAccountTokenHandlerFunc) {
...
func (mock *ServiceAccountTokenControllerMock) AddFeatureHandler(enabled func() bool, ctx context.Context, name string, sync v3.ServiceAccountTokenHandlerFunc) {
...
// Ensure, that ServiceAccountTokenInterfaceMock does implement ServiceAccountTokenInterface.
// If this is not the case, regenerate this file with moq.
var _ v3.ServiceAccountTokenInterface = &ServiceAccountTokenInterfaceMock{}
...
//             AddClusterScopedFeatureHandlerFunc: func(enabled func() bool, ctx context.Context, name string, clusterName string, sync v3.ServiceAccountTokenHandlerFunc)  {
// 	               panic("mock out the AddClusterScopedFeatureHandler method")
//             },
//             AddClusterScopedFeatureLifecycleFunc: func(enabled func() bool, ctx context.Context, name string, clusterName string, lifecycle v3.ServiceAccountTokenLifecycle)  {
...
// 	               panic("mock out the AddFeatureHandler method")
//             },
//             AddFeatureLifecycleFunc: func(enabled func() bool, ctx context.Context, name string, lifecycle v3.ServiceAccountTokenLifecycle)  {
...
// AddClusterScopedFeatureHandler calls AddClusterScopedFeatureHandlerFunc.
func (mock *ServiceAccountTokenInterfaceMock) AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name string, clusterName string, sync v3.ServiceAccountTokenHandlerFunc) {
	if mock.AddClusterScopedFeatureHandlerFunc == nil {
...
func (mock *ServiceAccountTokenInterfaceMock) AddClusterScopedFeatureLifecycle(enabled func() bool, ctx context.Context, name string, clusterName string, lifecycle v3.ServiceAccountTokenLifecycle) {
...
// AddFeatureHandler calls AddFeatureHandlerFunc.
func (mock *ServiceAccountTokenInterfaceMock) AddFeatureHandler(enabled func() bool, ctx context.Context, name string, sync v3.ServiceAccountTokenHandlerFunc) {
	if mock.AddFeatureHandlerFunc == nil {
...
func (mock *ServiceAccountTokenInterfaceMock) AddFeatureLifecycle(enabled func() bool, ctx context.Context, name string, lifecycle v3.ServiceAccountTokenLifecycle) {
...
// Ensure, that ServiceAccountTokensGetterMock does implement ServiceAccountTokensGetter.
// If this is not the case, regenerate this file with moq.
var _ v3.ServiceAccountTokensGetter = &ServiceAccountTokensGetterMock{}
