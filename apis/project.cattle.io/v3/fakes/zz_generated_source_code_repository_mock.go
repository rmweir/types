...
// Ensure, that SourceCodeRepositoryListerMock does implement SourceCodeRepositoryLister.
...
//             AddClusterScopedFeatureHandlerFunc: func(enabled func() bool, ctx context.Context, name string, clusterName string, handler v3.SourceCodeRepositoryHandlerFunc)  {
...
//             },
//             AddFeatureHandlerFunc: func(enabled func() bool, ctx context.Context, name string, sync v3.SourceCodeRepositoryHandlerFunc)  {
...
func (mock *SourceCodeRepositoryControllerMock) AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name string, clusterName string, handler v3.SourceCodeRepositoryHandlerFunc) {
...
func (mock *SourceCodeRepositoryControllerMock) AddFeatureHandler(enabled func() bool, ctx context.Context, name string, sync v3.SourceCodeRepositoryHandlerFunc) {
...
// Ensure, that SourceCodeRepositoryInterfaceMock does implement SourceCodeRepositoryInterface.
// If this is not the case, regenerate this file with moq.
...
//             AddClusterScopedFeatureHandlerFunc: func(enabled func() bool, ctx context.Context, name string, clusterName string, sync v3.SourceCodeRepositoryHandlerFunc)  {
// 	               panic("mock out the AddClusterScopedFeatureHandler method")
//             },
//             AddClusterScopedFeatureLifecycleFunc: func(enabled func() bool, ctx context.Context, name string, clusterName string, lifecycle v3.SourceCodeRepositoryLifecycle)  {
...
// 	               panic("mock out the AddFeatureHandler method")
//             },
//             AddFeatureLifecycleFunc: func(enabled func() bool, ctx context.Context, name string, lifecycle v3.SourceCodeRepositoryLifecycle)  {
...
// AddClusterScopedFeatureHandler calls AddClusterScopedFeatureHandlerFunc.
func (mock *SourceCodeRepositoryInterfaceMock) AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name string, clusterName string, sync v3.SourceCodeRepositoryHandlerFunc) {
	if mock.AddClusterScopedFeatureHandlerFunc == nil {
...
func (mock *SourceCodeRepositoryInterfaceMock) AddClusterScopedFeatureLifecycle(enabled func() bool, ctx context.Context, name string, clusterName string, lifecycle v3.SourceCodeRepositoryLifecycle) {
...
// AddFeatureHandler calls AddFeatureHandlerFunc.
func (mock *SourceCodeRepositoryInterfaceMock) AddFeatureHandler(enabled func() bool, ctx context.Context, name string, sync v3.SourceCodeRepositoryHandlerFunc) {
	if mock.AddFeatureHandlerFunc == nil {
...
func (mock *SourceCodeRepositoryInterfaceMock) AddFeatureLifecycle(enabled func() bool, ctx context.Context, name string, lifecycle v3.SourceCodeRepositoryLifecycle) {
...
// Ensure, that SourceCodeRepositoriesGetterMock does implement SourceCodeRepositoriesGetter.
// If this is not the case, regenerate this file with moq.
