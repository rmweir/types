...
// Ensure, that WorkloadListerMock does implement WorkloadLister.
// If this is not the case, regenerate this file with moq.
var _ v3.WorkloadLister = &WorkloadListerMock{}
...
// If this is not the case, regenerate this file with moq.
var _ v3.WorkloadController = &WorkloadControllerMock{}
...
//             AddClusterScopedFeatureHandlerFunc: func(enabled func() bool, ctx context.Context, name string, clusterName string, handler v3.WorkloadHandlerFunc)  {
...
//             },
//             AddFeatureHandlerFunc: func(enabled func() bool, ctx context.Context, name string, sync v3.WorkloadHandlerFunc)  {
...
func (mock *WorkloadControllerMock) AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name string, clusterName string, handler v3.WorkloadHandlerFunc) {
...
func (mock *WorkloadControllerMock) AddFeatureHandler(enabled func() bool, ctx context.Context, name string, sync v3.WorkloadHandlerFunc) {
...
// If this is not the case, regenerate this file with moq.
var _ v3.WorkloadInterface = &WorkloadInterfaceMock{}
...
//             AddClusterScopedFeatureHandlerFunc: func(enabled func() bool, ctx context.Context, name string, clusterName string, sync v3.WorkloadHandlerFunc)  {
// 	               panic("mock out the AddClusterScopedFeatureHandler method")
//             },
//             AddClusterScopedFeatureLifecycleFunc: func(enabled func() bool, ctx context.Context, name string, clusterName string, lifecycle v3.WorkloadLifecycle)  {
...
// 	               panic("mock out the AddFeatureHandler method")
//             },
//             AddFeatureLifecycleFunc: func(enabled func() bool, ctx context.Context, name string, lifecycle v3.WorkloadLifecycle)  {
...
// AddClusterScopedFeatureHandler calls AddClusterScopedFeatureHandlerFunc.
func (mock *WorkloadInterfaceMock) AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name string, clusterName string, sync v3.WorkloadHandlerFunc) {
	if mock.AddClusterScopedFeatureHandlerFunc == nil {
...
func (mock *WorkloadInterfaceMock) AddClusterScopedFeatureLifecycle(enabled func() bool, ctx context.Context, name string, clusterName string, lifecycle v3.WorkloadLifecycle) {
...
// AddFeatureHandler calls AddFeatureHandlerFunc.
func (mock *WorkloadInterfaceMock) AddFeatureHandler(enabled func() bool, ctx context.Context, name string, sync v3.WorkloadHandlerFunc) {
	if mock.AddFeatureHandlerFunc == nil {
...
func (mock *WorkloadInterfaceMock) AddFeatureLifecycle(enabled func() bool, ctx context.Context, name string, lifecycle v3.WorkloadLifecycle) {
...
// Ensure, that WorkloadsGetterMock does implement WorkloadsGetter.
// If this is not the case, regenerate this file with moq.
var _ v3.WorkloadsGetter = &WorkloadsGetterMock{}
