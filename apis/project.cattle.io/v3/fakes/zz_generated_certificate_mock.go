...
// Ensure, that CertificateListerMock does implement CertificateLister.
...
//             AddClusterScopedFeatureHandlerFunc: func(enabled func() bool, ctx context.Context, name string, clusterName string, handler v3.CertificateHandlerFunc)  {
...
//             },
//             AddFeatureHandlerFunc: func(enabled func() bool, ctx context.Context, name string, sync v3.CertificateHandlerFunc)  {
...
func (mock *CertificateControllerMock) AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name string, clusterName string, handler v3.CertificateHandlerFunc) {
...
func (mock *CertificateControllerMock) AddFeatureHandler(enabled func() bool, ctx context.Context, name string, sync v3.CertificateHandlerFunc) {
...
// Ensure, that CertificateInterfaceMock does implement CertificateInterface.
// If this is not the case, regenerate this file with moq.
...
//             AddClusterScopedFeatureHandlerFunc: func(enabled func() bool, ctx context.Context, name string, clusterName string, sync v3.CertificateHandlerFunc)  {
// 	               panic("mock out the AddClusterScopedFeatureHandler method")
//             },
//             AddClusterScopedFeatureLifecycleFunc: func(enabled func() bool, ctx context.Context, name string, clusterName string, lifecycle v3.CertificateLifecycle)  {
...
// 	               panic("mock out the AddFeatureHandler method")
//             },
//             AddFeatureLifecycleFunc: func(enabled func() bool, ctx context.Context, name string, lifecycle v3.CertificateLifecycle)  {
...
// AddClusterScopedFeatureHandler calls AddClusterScopedFeatureHandlerFunc.
func (mock *CertificateInterfaceMock) AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name string, clusterName string, sync v3.CertificateHandlerFunc) {
	if mock.AddClusterScopedFeatureHandlerFunc == nil {
...
func (mock *CertificateInterfaceMock) AddClusterScopedFeatureLifecycle(enabled func() bool, ctx context.Context, name string, clusterName string, lifecycle v3.CertificateLifecycle) {
...
// AddFeatureHandler calls AddFeatureHandlerFunc.
func (mock *CertificateInterfaceMock) AddFeatureHandler(enabled func() bool, ctx context.Context, name string, sync v3.CertificateHandlerFunc) {
	if mock.AddFeatureHandlerFunc == nil {
...
func (mock *CertificateInterfaceMock) AddFeatureLifecycle(enabled func() bool, ctx context.Context, name string, lifecycle v3.CertificateLifecycle) {
...
// Ensure, that CertificatesGetterMock does implement CertificatesGetter.
// If this is not the case, regenerate this file with moq.
