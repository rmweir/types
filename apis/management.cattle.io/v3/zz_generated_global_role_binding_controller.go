...
type GlobalRoleBindingController interface {
	...
	AddFeatureHandler(enabled func() bool, ctx context.Context, name string, sync GlobalRoleBindingHandlerFunc)
	AddClusterScopedHandler(ctx context.Context, name, clusterName string, handler GlobalRoleBindingHandlerFunc)
	AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name, clusterName string, handler GlobalRoleBindingHandlerFunc)
...
type GlobalRoleBindingInterface interface {
	...
	AddFeatureLifecycle(enabled func() bool, ctx context.Context, name string, lifecycle GlobalRoleBindingLifecycle)
	AddClusterScopedHandler(ctx context.Context, name, clusterName string, sync GlobalRoleBindingHandlerFunc)
	AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name, clusterName string, sync GlobalRoleBindingHandlerFunc)
	AddClusterScopedLifecycle(ctx context.Context, name, clusterName string, lifecycle GlobalRoleBindingLifecycle)
	AddClusterScopedFeatureLifecycle(enabled func() bool, ctx context.Context, name, clusterName string, lifecycle GlobalRoleBindingLifecycle)
}
...
func (c *globalRoleBindingController) AddFeatureHandler(enabled func() bool, ctx context.Context, name string, handler GlobalRoleBindingHandlerFunc) {
	c.GenericController.AddHandler(ctx, name, func(key string, obj interface{}) (interface{}, error) {
		if !enabled() {
			return nil, nil
		} else if obj == nil {
...
func (c *globalRoleBindingController) AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name, cluster string, handler GlobalRoleBindingHandlerFunc) {
	resource.PutClusterScoped(GlobalRoleBindingGroupVersionResource)
	c.GenericController.AddHandler(ctx, name, func(key string, obj interface{}) (interface{}, error) {
		if !enabled() {
			return nil, nil
...
func (s *globalRoleBindingClient) AddFeatureHandler(enabled func() bool, ctx context.Context, name string, sync GlobalRoleBindingHandlerFunc) {
...
func (s *globalRoleBindingClient) AddFeatureLifecycle(enabled func() bool, ctx context.Context, name string, lifecycle GlobalRoleBindingLifecycle) {
	sync := NewGlobalRoleBindingLifecycleAdapter(name, false, s, lifecycle)
	s.Controller().AddFeatureHandler(enabled, ctx, name, sync)
}
...
func (s *globalRoleBindingClient) AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name, clusterName string, sync GlobalRoleBindingHandlerFunc) {
...
func (s *globalRoleBindingClient) AddClusterScopedFeatureLifecycle(enabled func() bool, ctx context.Context, name, clusterName string, lifecycle GlobalRoleBindingLifecycle) {
	sync := NewGlobalRoleBindingLifecycleAdapter(name+"_"+clusterName, true, s, lifecycle)
	s.Controller().AddClusterScopedFeatureHandler(enabled, ctx, name, clusterName, sync)
}
