...
type ClusterRegistrationTokenController interface {
	...
	AddFeatureHandler(enabled func() bool, ctx context.Context, name string, sync ClusterRegistrationTokenHandlerFunc)
	AddClusterScopedHandler(ctx context.Context, name, clusterName string, handler ClusterRegistrationTokenHandlerFunc)
	AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name, clusterName string, handler ClusterRegistrationTokenHandlerFunc)
...
type ClusterRegistrationTokenInterface interface {
	...
	AddFeatureLifecycle(enabled func() bool, ctx context.Context, name string, lifecycle ClusterRegistrationTokenLifecycle)
	AddClusterScopedHandler(ctx context.Context, name, clusterName string, sync ClusterRegistrationTokenHandlerFunc)
	AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name, clusterName string, sync ClusterRegistrationTokenHandlerFunc)
	AddClusterScopedLifecycle(ctx context.Context, name, clusterName string, lifecycle ClusterRegistrationTokenLifecycle)
	AddClusterScopedFeatureLifecycle(enabled func() bool, ctx context.Context, name, clusterName string, lifecycle ClusterRegistrationTokenLifecycle)
}
...
func (c *clusterRegistrationTokenController) AddFeatureHandler(enabled func() bool, ctx context.Context, name string, handler ClusterRegistrationTokenHandlerFunc) {
	c.GenericController.AddHandler(ctx, name, func(key string, obj interface{}) (interface{}, error) {
		if !enabled() {
			return nil, nil
		} else if obj == nil {
...
func (c *clusterRegistrationTokenController) AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name, cluster string, handler ClusterRegistrationTokenHandlerFunc) {
	resource.PutClusterScoped(ClusterRegistrationTokenGroupVersionResource)
	c.GenericController.AddHandler(ctx, name, func(key string, obj interface{}) (interface{}, error) {
		if !enabled() {
			return nil, nil
...
func (s *clusterRegistrationTokenClient) AddFeatureHandler(enabled func() bool, ctx context.Context, name string, sync ClusterRegistrationTokenHandlerFunc) {
...
func (s *clusterRegistrationTokenClient) AddFeatureLifecycle(enabled func() bool, ctx context.Context, name string, lifecycle ClusterRegistrationTokenLifecycle) {
	sync := NewClusterRegistrationTokenLifecycleAdapter(name, false, s, lifecycle)
	s.Controller().AddFeatureHandler(enabled, ctx, name, sync)
}
...
func (s *clusterRegistrationTokenClient) AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name, clusterName string, sync ClusterRegistrationTokenHandlerFunc) {
...
func (s *clusterRegistrationTokenClient) AddClusterScopedFeatureLifecycle(enabled func() bool, ctx context.Context, name, clusterName string, lifecycle ClusterRegistrationTokenLifecycle) {
	sync := NewClusterRegistrationTokenLifecycleAdapter(name+"_"+clusterName, true, s, lifecycle)
	s.Controller().AddClusterScopedFeatureHandler(enabled, ctx, name, clusterName, sync)
}
