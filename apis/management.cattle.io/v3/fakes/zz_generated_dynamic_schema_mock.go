...
// Ensure, that DynamicSchemaListerMock does implement DynamicSchemaLister.
// If this is not the case, regenerate this file with moq.
var _ v3.DynamicSchemaLister = &DynamicSchemaListerMock{}
...
// If this is not the case, regenerate this file with moq.
var _ v3.DynamicSchemaController = &DynamicSchemaControllerMock{}
...
//             AddClusterScopedFeatureHandlerFunc: func(enabled func() bool, ctx context.Context, name string, clusterName string, handler v3.DynamicSchemaHandlerFunc)  {
...
//             },
//             AddFeatureHandlerFunc: func(enabled func() bool, ctx context.Context, name string, sync v3.DynamicSchemaHandlerFunc)  {
...
func (mock *DynamicSchemaControllerMock) AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name string, clusterName string, handler v3.DynamicSchemaHandlerFunc) {
...
func (mock *DynamicSchemaControllerMock) AddFeatureHandler(enabled func() bool, ctx context.Context, name string, sync v3.DynamicSchemaHandlerFunc) {
...
func (mock *DynamicSchemaControllerMock) Lister() v3.DynamicSchemaLister {
...
// If this is not the case, regenerate this file with moq.
var _ v3.DynamicSchemaInterface = &DynamicSchemaInterfaceMock{}
...
//             AddClusterScopedFeatureHandlerFunc: func(enabled func() bool, ctx context.Context, name string, clusterName string, sync v3.DynamicSchemaHandlerFunc)  {
// 	               panic("mock out the AddClusterScopedFeatureHandler method")
//             },
//             AddClusterScopedFeatureLifecycleFunc: func(enabled func() bool, ctx context.Context, name string, clusterName string, lifecycle v3.DynamicSchemaLifecycle)  {
...
// 	               panic("mock out the AddFeatureHandler method")
//             },
//             AddFeatureLifecycleFunc: func(enabled func() bool, ctx context.Context, name string, lifecycle v3.DynamicSchemaLifecycle)  {
...
// AddClusterScopedFeatureHandler calls AddClusterScopedFeatureHandlerFunc.
func (mock *DynamicSchemaInterfaceMock) AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name string, clusterName string, sync v3.DynamicSchemaHandlerFunc) {
	if mock.AddClusterScopedFeatureHandlerFunc == nil {
...
func (mock *DynamicSchemaInterfaceMock) AddClusterScopedFeatureLifecycle(enabled func() bool, ctx context.Context, name string, clusterName string, lifecycle v3.DynamicSchemaLifecycle) {
...
// AddFeatureHandler calls AddFeatureHandlerFunc.
func (mock *DynamicSchemaInterfaceMock) AddFeatureHandler(enabled func() bool, ctx context.Context, name string, sync v3.DynamicSchemaHandlerFunc) {
	if mock.AddFeatureHandlerFunc == nil {
...
func (mock *DynamicSchemaInterfaceMock) AddFeatureLifecycle(enabled func() bool, ctx context.Context, name string, lifecycle v3.DynamicSchemaLifecycle) {
...
func (mock *DynamicSchemaInterfaceMock) Controller() v3.DynamicSchemaController {
...
// Get calls GetFunc.
func (mock *DynamicSchemaInterfaceMock) Get(name string, opts v1.GetOptions) (*v3.DynamicSchema, error) {
	if mock.GetFunc == nil {
...
// List calls ListFunc.
func (mock *DynamicSchemaInterfaceMock) List(opts v1.ListOptions) (*v3.DynamicSchemaList, error) {
	if mock.ListFunc == nil {
...
func (mock *DynamicSchemaInterfaceMock) Watch(opts v1.ListOptions) (watch.Interface, error) {
...
// Ensure, that DynamicSchemasGetterMock does implement DynamicSchemasGetter.
// If this is not the case, regenerate this file with moq.
var _ v3.DynamicSchemasGetter = &DynamicSchemasGetterMock{}
