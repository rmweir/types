...
// Ensure, that GlobalRoleListerMock does implement GlobalRoleLister.
// If this is not the case, regenerate this file with moq.
var _ v3.GlobalRoleLister = &GlobalRoleListerMock{}
...
// If this is not the case, regenerate this file with moq.
var _ v3.GlobalRoleController = &GlobalRoleControllerMock{}
...
//             AddClusterScopedFeatureHandlerFunc: func(enabled func() bool, ctx context.Context, name string, clusterName string, handler v3.GlobalRoleHandlerFunc)  {
...
//             },
//             AddFeatureHandlerFunc: func(enabled func() bool, ctx context.Context, name string, sync v3.GlobalRoleHandlerFunc)  {
...
func (mock *GlobalRoleControllerMock) AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name string, clusterName string, handler v3.GlobalRoleHandlerFunc) {
...
func (mock *GlobalRoleControllerMock) AddFeatureHandler(enabled func() bool, ctx context.Context, name string, sync v3.GlobalRoleHandlerFunc) {
...
func (mock *GlobalRoleControllerMock) Lister() v3.GlobalRoleLister {
...
// If this is not the case, regenerate this file with moq.
var _ v3.GlobalRoleInterface = &GlobalRoleInterfaceMock{}
...
//             AddClusterScopedFeatureHandlerFunc: func(enabled func() bool, ctx context.Context, name string, clusterName string, sync v3.GlobalRoleHandlerFunc)  {
// 	               panic("mock out the AddClusterScopedFeatureHandler method")
//             },
//             AddClusterScopedFeatureLifecycleFunc: func(enabled func() bool, ctx context.Context, name string, clusterName string, lifecycle v3.GlobalRoleLifecycle)  {
...
// 	               panic("mock out the AddFeatureHandler method")
//             },
//             AddFeatureLifecycleFunc: func(enabled func() bool, ctx context.Context, name string, lifecycle v3.GlobalRoleLifecycle)  {
...
// AddClusterScopedFeatureHandler calls AddClusterScopedFeatureHandlerFunc.
func (mock *GlobalRoleInterfaceMock) AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name string, clusterName string, sync v3.GlobalRoleHandlerFunc) {
	if mock.AddClusterScopedFeatureHandlerFunc == nil {
...
func (mock *GlobalRoleInterfaceMock) AddClusterScopedFeatureLifecycle(enabled func() bool, ctx context.Context, name string, clusterName string, lifecycle v3.GlobalRoleLifecycle) {
...
// AddFeatureHandler calls AddFeatureHandlerFunc.
func (mock *GlobalRoleInterfaceMock) AddFeatureHandler(enabled func() bool, ctx context.Context, name string, sync v3.GlobalRoleHandlerFunc) {
	if mock.AddFeatureHandlerFunc == nil {
...
func (mock *GlobalRoleInterfaceMock) AddFeatureLifecycle(enabled func() bool, ctx context.Context, name string, lifecycle v3.GlobalRoleLifecycle) {
...
// List calls ListFunc.
func (mock *GlobalRoleInterfaceMock) List(opts v1.ListOptions) (*v3.GlobalRoleList, error) {
	if mock.ListFunc == nil {
...
func (mock *GlobalRoleInterfaceMock) Watch(opts v1.ListOptions) (watch.Interface, error) {
...
// Ensure, that GlobalRolesGetterMock does implement GlobalRolesGetter.
// If this is not the case, regenerate this file with moq.
var _ v3.GlobalRolesGetter = &GlobalRolesGetterMock{}
