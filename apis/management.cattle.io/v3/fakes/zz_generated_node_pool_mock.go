...
// Ensure, that NodePoolListerMock does implement NodePoolLister.
// If this is not the case, regenerate this file with moq.
var _ v3.NodePoolLister = &NodePoolListerMock{}
...
// If this is not the case, regenerate this file with moq.
var _ v3.NodePoolController = &NodePoolControllerMock{}
...
//             AddClusterScopedFeatureHandlerFunc: func(enabled func() bool, ctx context.Context, name string, clusterName string, handler v3.NodePoolHandlerFunc)  {
...
//             },
//             AddFeatureHandlerFunc: func(enabled func() bool, ctx context.Context, name string, sync v3.NodePoolHandlerFunc)  {
...
func (mock *NodePoolControllerMock) AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name string, clusterName string, handler v3.NodePoolHandlerFunc) {
...
func (mock *NodePoolControllerMock) AddFeatureHandler(enabled func() bool, ctx context.Context, name string, sync v3.NodePoolHandlerFunc) {
...
// If this is not the case, regenerate this file with moq.
var _ v3.NodePoolInterface = &NodePoolInterfaceMock{}
...
//             AddClusterScopedFeatureHandlerFunc: func(enabled func() bool, ctx context.Context, name string, clusterName string, sync v3.NodePoolHandlerFunc)  {
// 	               panic("mock out the AddClusterScopedFeatureHandler method")
//             },
//             AddClusterScopedFeatureLifecycleFunc: func(enabled func() bool, ctx context.Context, name string, clusterName string, lifecycle v3.NodePoolLifecycle)  {
...
// 	               panic("mock out the AddFeatureHandler method")
//             },
//             AddFeatureLifecycleFunc: func(enabled func() bool, ctx context.Context, name string, lifecycle v3.NodePoolLifecycle)  {
...
// AddClusterScopedFeatureHandler calls AddClusterScopedFeatureHandlerFunc.
func (mock *NodePoolInterfaceMock) AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name string, clusterName string, sync v3.NodePoolHandlerFunc) {
	if mock.AddClusterScopedFeatureHandlerFunc == nil {
...
func (mock *NodePoolInterfaceMock) AddClusterScopedFeatureLifecycle(enabled func() bool, ctx context.Context, name string, clusterName string, lifecycle v3.NodePoolLifecycle) {
...
// AddFeatureHandler calls AddFeatureHandlerFunc.
func (mock *NodePoolInterfaceMock) AddFeatureHandler(enabled func() bool, ctx context.Context, name string, sync v3.NodePoolHandlerFunc) {
	if mock.AddFeatureHandlerFunc == nil {
...
func (mock *NodePoolInterfaceMock) AddFeatureLifecycle(enabled func() bool, ctx context.Context, name string, lifecycle v3.NodePoolLifecycle) {
...
// List calls ListFunc.
func (mock *NodePoolInterfaceMock) List(opts v1.ListOptions) (*v3.NodePoolList, error) {
	if mock.ListFunc == nil {
...
func (mock *NodePoolInterfaceMock) Watch(opts v1.ListOptions) (watch.Interface, error) {
...
// Ensure, that NodePoolsGetterMock does implement NodePoolsGetter.
// If this is not the case, regenerate this file with moq.
var _ v3.NodePoolsGetter = &NodePoolsGetterMock{}
