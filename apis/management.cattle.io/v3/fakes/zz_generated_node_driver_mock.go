...
// Ensure, that NodeDriverListerMock does implement NodeDriverLister.
// If this is not the case, regenerate this file with moq.
var _ v3.NodeDriverLister = &NodeDriverListerMock{}
...
// If this is not the case, regenerate this file with moq.
var _ v3.NodeDriverController = &NodeDriverControllerMock{}
...
//             AddClusterScopedFeatureHandlerFunc: func(enabled func() bool, ctx context.Context, name string, clusterName string, handler v3.NodeDriverHandlerFunc)  {
...
//             },
//             AddFeatureHandlerFunc: func(enabled func() bool, ctx context.Context, name string, sync v3.NodeDriverHandlerFunc)  {
...
func (mock *NodeDriverControllerMock) AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name string, clusterName string, handler v3.NodeDriverHandlerFunc) {
...
func (mock *NodeDriverControllerMock) AddFeatureHandler(enabled func() bool, ctx context.Context, name string, sync v3.NodeDriverHandlerFunc) {
...
func (mock *NodeDriverControllerMock) Lister() v3.NodeDriverLister {
...
// If this is not the case, regenerate this file with moq.
var _ v3.NodeDriverInterface = &NodeDriverInterfaceMock{}
...
//             AddClusterScopedFeatureHandlerFunc: func(enabled func() bool, ctx context.Context, name string, clusterName string, sync v3.NodeDriverHandlerFunc)  {
// 	               panic("mock out the AddClusterScopedFeatureHandler method")
//             },
//             AddClusterScopedFeatureLifecycleFunc: func(enabled func() bool, ctx context.Context, name string, clusterName string, lifecycle v3.NodeDriverLifecycle)  {
...
// 	               panic("mock out the AddFeatureHandler method")
//             },
//             AddFeatureLifecycleFunc: func(enabled func() bool, ctx context.Context, name string, lifecycle v3.NodeDriverLifecycle)  {
...
// AddClusterScopedFeatureHandler calls AddClusterScopedFeatureHandlerFunc.
func (mock *NodeDriverInterfaceMock) AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name string, clusterName string, sync v3.NodeDriverHandlerFunc) {
	if mock.AddClusterScopedFeatureHandlerFunc == nil {
...
func (mock *NodeDriverInterfaceMock) AddClusterScopedFeatureLifecycle(enabled func() bool, ctx context.Context, name string, clusterName string, lifecycle v3.NodeDriverLifecycle) {
...
// AddFeatureHandler calls AddFeatureHandlerFunc.
func (mock *NodeDriverInterfaceMock) AddFeatureHandler(enabled func() bool, ctx context.Context, name string, sync v3.NodeDriverHandlerFunc) {
	if mock.AddFeatureHandlerFunc == nil {
...
func (mock *NodeDriverInterfaceMock) AddFeatureLifecycle(enabled func() bool, ctx context.Context, name string, lifecycle v3.NodeDriverLifecycle) {
...
// List calls ListFunc.
func (mock *NodeDriverInterfaceMock) List(opts v1.ListOptions) (*v3.NodeDriverList, error) {
	if mock.ListFunc == nil {
...
func (mock *NodeDriverInterfaceMock) Watch(opts v1.ListOptions) (watch.Interface, error) {
...
// Ensure, that NodeDriversGetterMock does implement NodeDriversGetter.
// If this is not the case, regenerate this file with moq.
var _ v3.NodeDriversGetter = &NodeDriversGetterMock{}
