...
// Ensure, that GroupMemberListerMock does implement GroupMemberLister.
// If this is not the case, regenerate this file with moq.
var _ v3.GroupMemberLister = &GroupMemberListerMock{}
...
// If this is not the case, regenerate this file with moq.
var _ v3.GroupMemberController = &GroupMemberControllerMock{}
...
//             AddClusterScopedFeatureHandlerFunc: func(enabled func() bool, ctx context.Context, name string, clusterName string, handler v3.GroupMemberHandlerFunc)  {
...
//             },
//             AddFeatureHandlerFunc: func(enabled func() bool, ctx context.Context, name string, sync v3.GroupMemberHandlerFunc)  {
...
func (mock *GroupMemberControllerMock) AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name string, clusterName string, handler v3.GroupMemberHandlerFunc) {
...
func (mock *GroupMemberControllerMock) AddFeatureHandler(enabled func() bool, ctx context.Context, name string, sync v3.GroupMemberHandlerFunc) {
...
func (mock *GroupMemberControllerMock) Lister() v3.GroupMemberLister {
...
// Ensure, that GroupMemberInterfaceMock does implement GroupMemberInterface.
// If this is not the case, regenerate this file with moq.
var _ v3.GroupMemberInterface = &GroupMemberInterfaceMock{}
...
//             AddClusterScopedFeatureHandlerFunc: func(enabled func() bool, ctx context.Context, name string, clusterName string, sync v3.GroupMemberHandlerFunc)  {
// 	               panic("mock out the AddClusterScopedFeatureHandler method")
//             },
//             AddClusterScopedFeatureLifecycleFunc: func(enabled func() bool, ctx context.Context, name string, clusterName string, lifecycle v3.GroupMemberLifecycle)  {
...
// 	               panic("mock out the AddFeatureHandler method")
//             },
//             AddFeatureLifecycleFunc: func(enabled func() bool, ctx context.Context, name string, lifecycle v3.GroupMemberLifecycle)  {
...
// AddClusterScopedFeatureHandler calls AddClusterScopedFeatureHandlerFunc.
func (mock *GroupMemberInterfaceMock) AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name string, clusterName string, sync v3.GroupMemberHandlerFunc) {
	if mock.AddClusterScopedFeatureHandlerFunc == nil {
...
func (mock *GroupMemberInterfaceMock) AddClusterScopedFeatureLifecycle(enabled func() bool, ctx context.Context, name string, clusterName string, lifecycle v3.GroupMemberLifecycle) {
...
// AddFeatureHandler calls AddFeatureHandlerFunc.
func (mock *GroupMemberInterfaceMock) AddFeatureHandler(enabled func() bool, ctx context.Context, name string, sync v3.GroupMemberHandlerFunc) {
	if mock.AddFeatureHandlerFunc == nil {
...
func (mock *GroupMemberInterfaceMock) AddFeatureLifecycle(enabled func() bool, ctx context.Context, name string, lifecycle v3.GroupMemberLifecycle) {
...
func (mock *GroupMemberInterfaceMock) Controller() v3.GroupMemberController {
...
// List calls ListFunc.
func (mock *GroupMemberInterfaceMock) List(opts v1.ListOptions) (*v3.GroupMemberList, error) {
	if mock.ListFunc == nil {
...
func (mock *GroupMemberInterfaceMock) Watch(opts v1.ListOptions) (watch.Interface, error) {
...
// Ensure, that GroupMembersGetterMock does implement GroupMembersGetter.
// If this is not the case, regenerate this file with moq.
var _ v3.GroupMembersGetter = &GroupMembersGetterMock{}
