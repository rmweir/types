...
// Ensure, that PrincipalListerMock does implement PrincipalLister.
// If this is not the case, regenerate this file with moq.
var _ v3.PrincipalLister = &PrincipalListerMock{}
...
// If this is not the case, regenerate this file with moq.
var _ v3.PrincipalController = &PrincipalControllerMock{}
...
//             AddClusterScopedFeatureHandlerFunc: func(enabled func() bool, ctx context.Context, name string, clusterName string, handler v3.PrincipalHandlerFunc)  {
...
//             },
//             AddFeatureHandlerFunc: func(enabled func() bool, ctx context.Context, name string, sync v3.PrincipalHandlerFunc)  {
...
func (mock *PrincipalControllerMock) AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name string, clusterName string, handler v3.PrincipalHandlerFunc) {
...
func (mock *PrincipalControllerMock) AddFeatureHandler(enabled func() bool, ctx context.Context, name string, sync v3.PrincipalHandlerFunc) {
...
func (mock *PrincipalControllerMock) Lister() v3.PrincipalLister {
...
// If this is not the case, regenerate this file with moq.
var _ v3.PrincipalInterface = &PrincipalInterfaceMock{}
...
//             AddClusterScopedFeatureHandlerFunc: func(enabled func() bool, ctx context.Context, name string, clusterName string, sync v3.PrincipalHandlerFunc)  {
// 	               panic("mock out the AddClusterScopedFeatureHandler method")
//             },
//             AddClusterScopedFeatureLifecycleFunc: func(enabled func() bool, ctx context.Context, name string, clusterName string, lifecycle v3.PrincipalLifecycle)  {
...
// 	               panic("mock out the AddFeatureHandler method")
//             },
//             AddFeatureLifecycleFunc: func(enabled func() bool, ctx context.Context, name string, lifecycle v3.PrincipalLifecycle)  {
...
// AddClusterScopedFeatureHandler calls AddClusterScopedFeatureHandlerFunc.
func (mock *PrincipalInterfaceMock) AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name string, clusterName string, sync v3.PrincipalHandlerFunc) {
	if mock.AddClusterScopedFeatureHandlerFunc == nil {
...
func (mock *PrincipalInterfaceMock) AddClusterScopedFeatureLifecycle(enabled func() bool, ctx context.Context, name string, clusterName string, lifecycle v3.PrincipalLifecycle) {
...
// AddFeatureHandler calls AddFeatureHandlerFunc.
func (mock *PrincipalInterfaceMock) AddFeatureHandler(enabled func() bool, ctx context.Context, name string, sync v3.PrincipalHandlerFunc) {
	if mock.AddFeatureHandlerFunc == nil {
...
func (mock *PrincipalInterfaceMock) AddFeatureLifecycle(enabled func() bool, ctx context.Context, name string, lifecycle v3.PrincipalLifecycle) {
...
// List calls ListFunc.
func (mock *PrincipalInterfaceMock) List(opts v1.ListOptions) (*v3.PrincipalList, error) {
	if mock.ListFunc == nil {
...
func (mock *PrincipalInterfaceMock) Watch(opts v1.ListOptions) (watch.Interface, error) {
...
// Ensure, that PrincipalsGetterMock does implement PrincipalsGetter.
// If this is not the case, regenerate this file with moq.
var _ v3.PrincipalsGetter = &PrincipalsGetterMock{}
