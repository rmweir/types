...
var _ v3.GroupLister = &GroupListerMock{}
...
// If this is not the case, regenerate this file with moq.
var _ v3.GroupController = &GroupControllerMock{}
...
//             AddClusterScopedFeatureHandlerFunc: func(enabled func() bool, ctx context.Context, name string, clusterName string, handler v3.GroupHandlerFunc)  {
...
//             },
//             AddFeatureHandlerFunc: func(enabled func() bool, ctx context.Context, name string, sync v3.GroupHandlerFunc)  {
...
func (mock *GroupControllerMock) AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name string, clusterName string, handler v3.GroupHandlerFunc) {
...
func (mock *GroupControllerMock) AddFeatureHandler(enabled func() bool, ctx context.Context, name string, sync v3.GroupHandlerFunc) {
...
// If this is not the case, regenerate this file with moq.
var _ v3.GroupInterface = &GroupInterfaceMock{}
...
//             AddClusterScopedFeatureHandlerFunc: func(enabled func() bool, ctx context.Context, name string, clusterName string, sync v3.GroupHandlerFunc)  {
// 	               panic("mock out the AddClusterScopedFeatureHandler method")
//             },
//             AddClusterScopedFeatureLifecycleFunc: func(enabled func() bool, ctx context.Context, name string, clusterName string, lifecycle v3.GroupLifecycle)  {
...
// 	               panic("mock out the AddFeatureHandler method")
//             },
//             AddFeatureLifecycleFunc: func(enabled func() bool, ctx context.Context, name string, lifecycle v3.GroupLifecycle)  {
...
// AddClusterScopedFeatureHandler calls AddClusterScopedFeatureHandlerFunc.
func (mock *GroupInterfaceMock) AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name string, clusterName string, sync v3.GroupHandlerFunc) {
	if mock.AddClusterScopedFeatureHandlerFunc == nil {
...
func (mock *GroupInterfaceMock) AddClusterScopedFeatureLifecycle(enabled func() bool, ctx context.Context, name string, clusterName string, lifecycle v3.GroupLifecycle) {
...
// AddFeatureHandler calls AddFeatureHandlerFunc.
func (mock *GroupInterfaceMock) AddFeatureHandler(enabled func() bool, ctx context.Context, name string, sync v3.GroupHandlerFunc) {
	if mock.AddFeatureHandlerFunc == nil {
...
func (mock *GroupInterfaceMock) AddFeatureLifecycle(enabled func() bool, ctx context.Context, name string, lifecycle v3.GroupLifecycle) {
...
// Ensure, that GroupsGetterMock does implement GroupsGetter.
// If this is not the case, regenerate this file with moq.
var _ v3.GroupsGetter = &GroupsGetterMock{}
