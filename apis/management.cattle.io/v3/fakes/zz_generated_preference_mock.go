...
// Ensure, that PreferenceListerMock does implement PreferenceLister.
// If this is not the case, regenerate this file with moq.
var _ v3.PreferenceLister = &PreferenceListerMock{}
...
// If this is not the case, regenerate this file with moq.
var _ v3.PreferenceController = &PreferenceControllerMock{}
...
//             AddClusterScopedFeatureHandlerFunc: func(enabled func() bool, ctx context.Context, name string, clusterName string, handler v3.PreferenceHandlerFunc)  {
...
//             },
//             AddFeatureHandlerFunc: func(enabled func() bool, ctx context.Context, name string, sync v3.PreferenceHandlerFunc)  {
...
func (mock *PreferenceControllerMock) AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name string, clusterName string, handler v3.PreferenceHandlerFunc) {
...
func (mock *PreferenceControllerMock) AddFeatureHandler(enabled func() bool, ctx context.Context, name string, sync v3.PreferenceHandlerFunc) {
...
func (mock *PreferenceControllerMock) Lister() v3.PreferenceLister {
...
// If this is not the case, regenerate this file with moq.
var _ v3.PreferenceInterface = &PreferenceInterfaceMock{}
...
//             AddClusterScopedFeatureHandlerFunc: func(enabled func() bool, ctx context.Context, name string, clusterName string, sync v3.PreferenceHandlerFunc)  {
// 	               panic("mock out the AddClusterScopedFeatureHandler method")
//             },
//             AddClusterScopedFeatureLifecycleFunc: func(enabled func() bool, ctx context.Context, name string, clusterName string, lifecycle v3.PreferenceLifecycle)  {
...
// 	               panic("mock out the AddFeatureHandler method")
//             },
//             AddFeatureLifecycleFunc: func(enabled func() bool, ctx context.Context, name string, lifecycle v3.PreferenceLifecycle)  {
...
// AddClusterScopedFeatureHandler calls AddClusterScopedFeatureHandlerFunc.
func (mock *PreferenceInterfaceMock) AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name string, clusterName string, sync v3.PreferenceHandlerFunc) {
	if mock.AddClusterScopedFeatureHandlerFunc == nil {
...
func (mock *PreferenceInterfaceMock) AddClusterScopedFeatureLifecycle(enabled func() bool, ctx context.Context, name string, clusterName string, lifecycle v3.PreferenceLifecycle) {
...
// AddFeatureHandler calls AddFeatureHandlerFunc.
func (mock *PreferenceInterfaceMock) AddFeatureHandler(enabled func() bool, ctx context.Context, name string, sync v3.PreferenceHandlerFunc) {
	if mock.AddFeatureHandlerFunc == nil {
...
func (mock *PreferenceInterfaceMock) AddFeatureLifecycle(enabled func() bool, ctx context.Context, name string, lifecycle v3.PreferenceLifecycle) {
...
// List calls ListFunc.
func (mock *PreferenceInterfaceMock) List(opts v1.ListOptions) (*v3.PreferenceList, error) {
	if mock.ListFunc == nil {
...
func (mock *PreferenceInterfaceMock) Watch(opts v1.ListOptions) (watch.Interface, error) {
...
// Ensure, that PreferencesGetterMock does implement PreferencesGetter.
// If this is not the case, regenerate this file with moq.
var _ v3.PreferencesGetter = &PreferencesGetterMock{}
