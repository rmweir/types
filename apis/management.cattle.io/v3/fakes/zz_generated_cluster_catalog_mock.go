...
// Ensure, that ClusterCatalogListerMock does implement ClusterCatalogLister.
// If this is not the case, regenerate this file with moq.
var _ v3.ClusterCatalogLister = &ClusterCatalogListerMock{}
...
// If this is not the case, regenerate this file with moq.
var _ v3.ClusterCatalogController = &ClusterCatalogControllerMock{}
...
//             AddClusterScopedFeatureHandlerFunc: func(enabled func() bool, ctx context.Context, name string, clusterName string, handler v3.ClusterCatalogHandlerFunc)  {
...
//             },
//             AddFeatureHandlerFunc: func(enabled func() bool, ctx context.Context, name string, sync v3.ClusterCatalogHandlerFunc)  {
...
func (mock *ClusterCatalogControllerMock) AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name string, clusterName string, handler v3.ClusterCatalogHandlerFunc) {
...
func (mock *ClusterCatalogControllerMock) AddFeatureHandler(enabled func() bool, ctx context.Context, name string, sync v3.ClusterCatalogHandlerFunc) {
...
func (mock *ClusterCatalogControllerMock) Lister() v3.ClusterCatalogLister {
...
// Ensure, that ClusterCatalogInterfaceMock does implement ClusterCatalogInterface.
// If this is not the case, regenerate this file with moq.
var _ v3.ClusterCatalogInterface = &ClusterCatalogInterfaceMock{}
...
//             AddClusterScopedFeatureHandlerFunc: func(enabled func() bool, ctx context.Context, name string, clusterName string, sync v3.ClusterCatalogHandlerFunc)  {
// 	               panic("mock out the AddClusterScopedFeatureHandler method")
//             },
//             AddClusterScopedFeatureLifecycleFunc: func(enabled func() bool, ctx context.Context, name string, clusterName string, lifecycle v3.ClusterCatalogLifecycle)  {
...
// 	               panic("mock out the AddFeatureHandler method")
//             },
//             AddFeatureLifecycleFunc: func(enabled func() bool, ctx context.Context, name string, lifecycle v3.ClusterCatalogLifecycle)  {
...
// AddClusterScopedFeatureHandler calls AddClusterScopedFeatureHandlerFunc.
func (mock *ClusterCatalogInterfaceMock) AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name string, clusterName string, sync v3.ClusterCatalogHandlerFunc) {
	if mock.AddClusterScopedFeatureHandlerFunc == nil {
...
func (mock *ClusterCatalogInterfaceMock) AddClusterScopedFeatureLifecycle(enabled func() bool, ctx context.Context, name string, clusterName string, lifecycle v3.ClusterCatalogLifecycle) {
...
// AddFeatureHandler calls AddFeatureHandlerFunc.
func (mock *ClusterCatalogInterfaceMock) AddFeatureHandler(enabled func() bool, ctx context.Context, name string, sync v3.ClusterCatalogHandlerFunc) {
	if mock.AddFeatureHandlerFunc == nil {
...
func (mock *ClusterCatalogInterfaceMock) AddFeatureLifecycle(enabled func() bool, ctx context.Context, name string, lifecycle v3.ClusterCatalogLifecycle) {
...
// AddHandler calls AddHandlerFunc.
func (mock *ClusterCatalogInterfaceMock) AddHandler(ctx context.Context, name string, sync v3.ClusterCatalogHandlerFunc) {
	if mock.AddHandlerFunc == nil {
...
func (mock *ClusterCatalogInterfaceMock) Controller() v3.ClusterCatalogController {
...
// Get calls GetFunc.
func (mock *ClusterCatalogInterfaceMock) Get(name string, opts v1.GetOptions) (*v3.ClusterCatalog, error) {
	if mock.GetFunc == nil {
...
// List calls ListFunc.
func (mock *ClusterCatalogInterfaceMock) List(opts v1.ListOptions) (*v3.ClusterCatalogList, error) {
	if mock.ListFunc == nil {
...
func (mock *ClusterCatalogInterfaceMock) Watch(opts v1.ListOptions) (watch.Interface, error) {
...
// Ensure, that ClusterCatalogsGetterMock does implement ClusterCatalogsGetter.
// If this is not the case, regenerate this file with moq.
var _ v3.ClusterCatalogsGetter = &ClusterCatalogsGetterMock{}
