...
var _ v3.NodeLister = &NodeListerMock{}
...
// If this is not the case, regenerate this file with moq.
var _ v3.NodeController = &NodeControllerMock{}
...
//             AddClusterScopedFeatureHandlerFunc: func(enabled func() bool, ctx context.Context, name string, clusterName string, handler v3.NodeHandlerFunc)  {
...
//             },
//             AddFeatureHandlerFunc: func(enabled func() bool, ctx context.Context, name string, sync v3.NodeHandlerFunc)  {
...
func (mock *NodeControllerMock) AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name string, clusterName string, handler v3.NodeHandlerFunc) {
...
func (mock *NodeControllerMock) AddFeatureHandler(enabled func() bool, ctx context.Context, name string, sync v3.NodeHandlerFunc) {
...
// If this is not the case, regenerate this file with moq.
var _ v3.NodeInterface = &NodeInterfaceMock{}
...
//             AddClusterScopedFeatureHandlerFunc: func(enabled func() bool, ctx context.Context, name string, clusterName string, sync v3.NodeHandlerFunc)  {
// 	               panic("mock out the AddClusterScopedFeatureHandler method")
//             },
//             AddClusterScopedFeatureLifecycleFunc: func(enabled func() bool, ctx context.Context, name string, clusterName string, lifecycle v3.NodeLifecycle)  {
...
// 	               panic("mock out the AddFeatureHandler method")
//             },
//             AddFeatureLifecycleFunc: func(enabled func() bool, ctx context.Context, name string, lifecycle v3.NodeLifecycle)  {
...
// AddClusterScopedFeatureHandler calls AddClusterScopedFeatureHandlerFunc.
func (mock *NodeInterfaceMock) AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name string, clusterName string, sync v3.NodeHandlerFunc) {
	if mock.AddClusterScopedFeatureHandlerFunc == nil {
...
func (mock *NodeInterfaceMock) AddClusterScopedFeatureLifecycle(enabled func() bool, ctx context.Context, name string, clusterName string, lifecycle v3.NodeLifecycle) {
...
// AddFeatureHandler calls AddFeatureHandlerFunc.
func (mock *NodeInterfaceMock) AddFeatureHandler(enabled func() bool, ctx context.Context, name string, sync v3.NodeHandlerFunc) {
	if mock.AddFeatureHandlerFunc == nil {
...
func (mock *NodeInterfaceMock) AddFeatureLifecycle(enabled func() bool, ctx context.Context, name string, lifecycle v3.NodeLifecycle) {
...
// If this is not the case, regenerate this file with moq.
var _ v3.NodesGetter = &NodesGetterMock{}
