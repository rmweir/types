...
// Ensure, that AuthConfigListerMock does implement AuthConfigLister.
// If this is not the case, regenerate this file with moq.
var _ v3.AuthConfigLister = &AuthConfigListerMock{}
...
// If this is not the case, regenerate this file with moq.
var _ v3.AuthConfigController = &AuthConfigControllerMock{}
...
//             AddClusterScopedFeatureHandlerFunc: func(enabled func() bool, ctx context.Context, name string, clusterName string, handler v3.AuthConfigHandlerFunc)  {
...
//             },
//             AddFeatureHandlerFunc: func(enabled func() bool, ctx context.Context, name string, sync v3.AuthConfigHandlerFunc)  {
...
func (mock *AuthConfigControllerMock) AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name string, clusterName string, handler v3.AuthConfigHandlerFunc) {
...
func (mock *AuthConfigControllerMock) AddFeatureHandler(enabled func() bool, ctx context.Context, name string, sync v3.AuthConfigHandlerFunc) {
...
func (mock *AuthConfigControllerMock) Lister() v3.AuthConfigLister {
...
// Ensure, that AuthConfigInterfaceMock does implement AuthConfigInterface.
// If this is not the case, regenerate this file with moq.
var _ v3.AuthConfigInterface = &AuthConfigInterfaceMock{}
...
//             AddClusterScopedFeatureHandlerFunc: func(enabled func() bool, ctx context.Context, name string, clusterName string, sync v3.AuthConfigHandlerFunc)  {
// 	               panic("mock out the AddClusterScopedFeatureHandler method")
//             },
//             AddClusterScopedFeatureLifecycleFunc: func(enabled func() bool, ctx context.Context, name string, clusterName string, lifecycle v3.AuthConfigLifecycle)  {
...
// 	               panic("mock out the AddFeatureHandler method")
//             },
//             AddFeatureLifecycleFunc: func(enabled func() bool, ctx context.Context, name string, lifecycle v3.AuthConfigLifecycle)  {
...
// AddClusterScopedFeatureHandler calls AddClusterScopedFeatureHandlerFunc.
func (mock *AuthConfigInterfaceMock) AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name string, clusterName string, sync v3.AuthConfigHandlerFunc) {
	if mock.AddClusterScopedFeatureHandlerFunc == nil {
...
func (mock *AuthConfigInterfaceMock) AddClusterScopedFeatureLifecycle(enabled func() bool, ctx context.Context, name string, clusterName string, lifecycle v3.AuthConfigLifecycle) {
...
// AddFeatureHandler calls AddFeatureHandlerFunc.
func (mock *AuthConfigInterfaceMock) AddFeatureHandler(enabled func() bool, ctx context.Context, name string, sync v3.AuthConfigHandlerFunc) {
	if mock.AddFeatureHandlerFunc == nil {
...
func (mock *AuthConfigInterfaceMock) AddFeatureLifecycle(enabled func() bool, ctx context.Context, name string, lifecycle v3.AuthConfigLifecycle) {
...
// List calls ListFunc.
func (mock *AuthConfigInterfaceMock) List(opts v1.ListOptions) (*v3.AuthConfigList, error) {
	if mock.ListFunc == nil {
...
func (mock *AuthConfigInterfaceMock) Watch(opts v1.ListOptions) (watch.Interface, error) {
...
// Ensure, that AuthConfigsGetterMock does implement AuthConfigsGetter.
// If this is not the case, regenerate this file with moq.
var _ v3.AuthConfigsGetter = &AuthConfigsGetterMock{}
