...
type PodSecurityPolicyTemplateProjectBindingController interface {
	...
	AddFeatureHandler(enabled func() bool, ctx context.Context, name string, sync PodSecurityPolicyTemplateProjectBindingHandlerFunc)
	...
	AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name, clusterName string, handler PodSecurityPolicyTemplateProjectBindingHandlerFunc)
...
type PodSecurityPolicyTemplateProjectBindingInterface interface {
	...
	AddFeatureLifecycle(enabled func() bool, ctx context.Context, name string, lifecycle PodSecurityPolicyTemplateProjectBindingLifecycle)
	...
	AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name, clusterName string, sync PodSecurityPolicyTemplateProjectBindingHandlerFunc)
	...
	AddClusterScopedFeatureLifecycle(enabled func() bool, ctx context.Context, name, clusterName string, lifecycle PodSecurityPolicyTemplateProjectBindingLifecycle)
}
...
func (c *podSecurityPolicyTemplateProjectBindingController) AddFeatureHandler(enabled func() bool, ctx context.Context, name string, handler PodSecurityPolicyTemplateProjectBindingHandlerFunc) {
	c.GenericController.AddHandler(ctx, name, func(key string, obj interface{}) (interface{}, error) {
		if !enabled() {
			return nil, nil
		} else if obj == nil {
...
func (c *podSecurityPolicyTemplateProjectBindingController) AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name, cluster string, handler PodSecurityPolicyTemplateProjectBindingHandlerFunc) {
	resource.PutClusterScoped(PodSecurityPolicyTemplateProjectBindingGroupVersionResource)
	c.GenericController.AddHandler(ctx, name, func(key string, obj interface{}) (interface{}, error) {
		if !enabled() {
			return nil, nil
...
func (s *podSecurityPolicyTemplateProjectBindingClient) AddFeatureHandler(enabled func() bool, ctx context.Context, name string, sync PodSecurityPolicyTemplateProjectBindingHandlerFunc) {
...
func (s *podSecurityPolicyTemplateProjectBindingClient) AddFeatureLifecycle(enabled func() bool, ctx context.Context, name string, lifecycle PodSecurityPolicyTemplateProjectBindingLifecycle) {
	sync := NewPodSecurityPolicyTemplateProjectBindingLifecycleAdapter(name, false, s, lifecycle)
	s.Controller().AddFeatureHandler(enabled, ctx, name, sync)
}
...
func (s *podSecurityPolicyTemplateProjectBindingClient) AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name, clusterName string, sync PodSecurityPolicyTemplateProjectBindingHandlerFunc) {
...
func (s *podSecurityPolicyTemplateProjectBindingClient) AddClusterScopedFeatureLifecycle(enabled func() bool, ctx context.Context, name, clusterName string, lifecycle PodSecurityPolicyTemplateProjectBindingLifecycle) {
	sync := NewPodSecurityPolicyTemplateProjectBindingLifecycleAdapter(name+"_"+clusterName, true, s, lifecycle)
	s.Controller().AddClusterScopedFeatureHandler(enabled, ctx, name, clusterName, sync)
}
