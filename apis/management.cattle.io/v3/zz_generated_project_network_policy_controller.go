...
type ProjectNetworkPolicyController interface {
	...
	AddFeatureHandler(enabled func() bool, ctx context.Context, name string, sync ProjectNetworkPolicyHandlerFunc)
	AddClusterScopedHandler(ctx context.Context, name, clusterName string, handler ProjectNetworkPolicyHandlerFunc)
	AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name, clusterName string, handler ProjectNetworkPolicyHandlerFunc)
...
type ProjectNetworkPolicyInterface interface {
	...
	AddFeatureLifecycle(enabled func() bool, ctx context.Context, name string, lifecycle ProjectNetworkPolicyLifecycle)
	AddClusterScopedHandler(ctx context.Context, name, clusterName string, sync ProjectNetworkPolicyHandlerFunc)
	AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name, clusterName string, sync ProjectNetworkPolicyHandlerFunc)
	AddClusterScopedLifecycle(ctx context.Context, name, clusterName string, lifecycle ProjectNetworkPolicyLifecycle)
	AddClusterScopedFeatureLifecycle(enabled func() bool, ctx context.Context, name, clusterName string, lifecycle ProjectNetworkPolicyLifecycle)
}
...
func (c *projectNetworkPolicyController) AddFeatureHandler(enabled func() bool, ctx context.Context, name string, handler ProjectNetworkPolicyHandlerFunc) {
	c.GenericController.AddHandler(ctx, name, func(key string, obj interface{}) (interface{}, error) {
		if !enabled() {
			return nil, nil
		} else if obj == nil {
...
func (c *projectNetworkPolicyController) AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name, cluster string, handler ProjectNetworkPolicyHandlerFunc) {
	resource.PutClusterScoped(ProjectNetworkPolicyGroupVersionResource)
	c.GenericController.AddHandler(ctx, name, func(key string, obj interface{}) (interface{}, error) {
		if !enabled() {
			return nil, nil
...
func (s *projectNetworkPolicyClient) AddFeatureHandler(enabled func() bool, ctx context.Context, name string, sync ProjectNetworkPolicyHandlerFunc) {
...
func (s *projectNetworkPolicyClient) AddFeatureLifecycle(enabled func() bool, ctx context.Context, name string, lifecycle ProjectNetworkPolicyLifecycle) {
	sync := NewProjectNetworkPolicyLifecycleAdapter(name, false, s, lifecycle)
	s.Controller().AddFeatureHandler(enabled, ctx, name, sync)
}
...
func (s *projectNetworkPolicyClient) AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name, clusterName string, sync ProjectNetworkPolicyHandlerFunc) {
...
func (s *projectNetworkPolicyClient) AddClusterScopedFeatureLifecycle(enabled func() bool, ctx context.Context, name, clusterName string, lifecycle ProjectNetworkPolicyLifecycle) {
	sync := NewProjectNetworkPolicyLifecycleAdapter(name+"_"+clusterName, true, s, lifecycle)
	s.Controller().AddClusterScopedFeatureHandler(enabled, ctx, name, clusterName, sync)
}
