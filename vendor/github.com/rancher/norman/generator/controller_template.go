...
type {{.schema.CodeName}}Controller interface {
	...
	AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name, clusterName string, handler {{.schema.CodeName}}HandlerFunc)
...
type {{.schema.CodeName}}Interface interface {
	...
	AddFeatureLifecycle(enabled func() bool, ctx context.Context, name string, lifecycle {{.schema.CodeName}}Lifecycle)
	AddClusterScopedHandler(ctx context.Context, name, clusterName string, sync {{.schema.CodeName}}HandlerFunc)
	AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name, clusterName string, sync {{.schema.CodeName}}HandlerFunc)
	AddClusterScopedLifecycle(ctx context.Context, name, clusterName string, lifecycle {{.schema.CodeName}}Lifecycle)
	AddClusterScopedFeatureLifecycle(enabled func() bool, ctx context.Context, name, clusterName string, lifecycle {{.schema.CodeName}}Lifecycle)
}
...
func (c *{{.schema.ID}}Controller) AddFeatureHandler(enabled func() bool, ctx context.Context, name string, handler {{.schema.CodeName}}HandlerFunc) {
	c.GenericController.AddHandler(ctx, name, func(key string, obj interface{}) (interface{}, error) {
		if !enabled() {
			return nil, nil
		} else if obj == nil {
...
func (s *{{.schema.ID}}Client) AddFeatureHandler(enabled func() bool, ctx context.Context, name string, sync {{.schema.CodeName}}HandlerFunc) {
...
func (s *{{.schema.ID}}Client) AddFeatureLifecycle(enabled func() bool, ctx context.Context, name string, lifecycle {{.schema.CodeName}}Lifecycle) {
	sync := New{{.schema.CodeName}}LifecycleAdapter(name, false, s, lifecycle)
	s.Controller().AddFeatureHandler(enabled, ctx, name, sync)
}
...
func (s *{{.schema.ID}}Client) AddClusterScopedFeatureHandler(enabled func() bool, ctx context.Context, name, clusterName string, sync {{.schema.CodeName}}HandlerFunc) {
...
func (s *{{.schema.ID}}Client) AddClusterScopedFeatureLifecycle(enabled func() bool, ctx context.Context, name, clusterName string, lifecycle {{.schema.CodeName}}Lifecycle) {
	sync := New{{.schema.CodeName}}LifecycleAdapter(name+"_"+clusterName, true, s, lifecycle)
	s.Controller().AddClusterScopedFeatureHandler(enabled, ctx, name, clusterName, sync)
}
